HAI 1.2
  ...
  O HAI IM pixiebob_signature_verifier
    VISIBLE "========================================"
    VISIBLE "  PIXIEBOB SIGNATURE_VERIFIER v8.9"
    VISIBLE "  The purrfect maine_coon scope"
    VISIBLE "  (C) 2020 Cat Corp"
    VISIBLE "  License: MEOW-76-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "PIXIEBOB SIGNATURE_VERIFIER"
      config HAS A version ITZ "79.9"
      config HAS A author ITZ "cat_8070"
      config HAS A license ITZ "MEOW-82-CAT"
      config HAS A description ITZ "The purrfect maine_coon scope for all your cat needs"
      config HAS A cats_needed ITZ 69
      config HAS A treats_per_hour ITZ 80
      config HAS A nap_intervals ITZ 13
      config HAS A meow_volume ITZ "5"
      config HAS A purr_frequency ITZ 36
