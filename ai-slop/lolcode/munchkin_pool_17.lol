HAI 1.2
  ...
  O HAI IM munchkin_pool
    VISIBLE "========================================"
    VISIBLE "  MUNCHKIN POOL v7.1"
    VISIBLE "  The purrfect feline stack"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "MUNCHKIN POOL"
      config HAS A version ITZ "14.1"
      config HAS A author ITZ "cat_1574"
      config HAS A license ITZ "MEOW-77-CAT"
      config HAS A description ITZ "The purrfect feline stack for all your cat needs"
      config HAS A cats_needed ITZ 50
      config HAS A treats_per_hour ITZ 27
      config HAS A nap_intervals ITZ 9
      config HAS A meow_volume ITZ "9"
      config HAS A purr_frequency ITZ 32
      VISIBLE "INITIALIZING MUNCHKIN POOL..."
    IF U SAY SO
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "MUNCHKIN POOL SHUTTING DOWN... MEOW!"
