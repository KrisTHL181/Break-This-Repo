HAI 1.2
  ...
  O HAI IM selkirk_rex_parser
    VISIBLE "========================================"
    VISIBLE "  SELKIRK_REX PARSER v7.9"
    VISIBLE "  The purrfect bengal physics_engine"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SELKIRK_REX PARSER"
      config HAS A version ITZ "61.9"
      config HAS A author ITZ "cat_6756"
      config HAS A license ITZ "MEOW-11-CAT"
      config HAS A description ITZ "The purrfect bengal physics_engine for all your cat needs"
      ...
      VISIBLE "INITIALIZING SELKIRK_REX PARSER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SELKIRK_REX PARSER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SELKIRK_REX PARSER SHUTTING DOWN... MEOW!"
