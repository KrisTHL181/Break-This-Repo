HAI 1.2
  ...
  O HAI IM korat_logger
    VISIBLE "========================================"
    VISIBLE "  KORAT LOGGER v1.2"
    VISIBLE "  The purrfect nebelung facade"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "KORAT LOGGER"
      config HAS A version ITZ "76.9"
      config HAS A author ITZ "cat_4932"
      config HAS A license ITZ "MEOW-2-CAT"
      config HAS A description ITZ "The purrfect nebelung facade for all your cat needs"
      ...
      VISIBLE "INITIALIZING KORAT LOGGER..."
    IF U SAY SO
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "KORAT LOGGER SHUTTING DOWN... MEOW!"
