HAI 1.2
  ...
  O HAI IM pixiebob_fuzzer
    VISIBLE "========================================"
    VISIBLE "  PIXIEBOB FUZZER v1.7"
    VISIBLE "  The purrfect snowshoe handler"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "PIXIEBOB FUZZER"
      config HAS A version ITZ "2.3"
      config HAS A author ITZ "cat_3034"
      config HAS A license ITZ "MEOW-34-CAT"
      config HAS A description ITZ "The purrfect snowshoe handler for all your cat needs"
      config HAS A cats_needed ITZ 52
      config HAS A treats_per_hour ITZ 55
      config HAS A nap_intervals ITZ 12
      config HAS A meow_volume ITZ "5"
      config HAS A purr_frequency ITZ 21
      VISIBLE "INITIALIZING PIXIEBOB FUZZER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING PIXIEBOB FUZZER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "PIXIEBOB FUZZER SHUTTING DOWN... MEOW!"
