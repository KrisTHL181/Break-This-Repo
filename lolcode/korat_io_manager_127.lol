HAI 1.2
  ...
  O HAI IM korat_io_manager
    VISIBLE "========================================"
    VISIBLE "  KORAT IO_MANAGER v1.8"
    VISIBLE "  The purrfect tabby analyzer"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "KORAT IO_MANAGER"
      config HAS A version ITZ "27.0"
      config HAS A author ITZ "cat_5557"
      config HAS A license ITZ "MEOW-44-CAT"
      config HAS A description ITZ "The purrfect tabby analyzer for all your cat needs"
      config HAS A cats_needed ITZ 34
      config HAS A treats_per_hour ITZ 22
      config HAS A nap_intervals ITZ 24
      config HAS A meow_volume ITZ "5"
      config HAS A purr_frequency ITZ 39
      VISIBLE "INITIALIZING KORAT IO_MANAGER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING KORAT IO_MANAGER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "KORAT IO_MANAGER SHUTTING DOWN... MEOW!"
