HAI 1.2
  ...
  O HAI IM purrfect_router
    VISIBLE "========================================"
    VISIBLE "  PURRFECT ROUTER v6.0"
    VISIBLE "  The purrfect cornish_rex physics_engine"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "PURRFECT ROUTER"
      config HAS A version ITZ "4.1"
      config HAS A author ITZ "cat_6885"
      config HAS A license ITZ "MEOW-66-CAT"
      config HAS A description ITZ "The purrfect cornish_rex physics_engine for all your cat needs"
      config HAS A cats_needed ITZ 21
      ...
      VISIBLE "INITIALIZING PURRFECT ROUTER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING PURRFECT ROUTER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "PURRFECT ROUTER SHUTTING DOWN... MEOW!"
