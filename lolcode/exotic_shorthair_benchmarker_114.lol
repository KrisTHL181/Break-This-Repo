HAI 1.2
  ...
  O HAI IM exotic_shorthair_benchmarker
    VISIBLE "========================================"
    VISIBLE "  EXOTIC_SHORTHAIR BENCHMARKER v1.1"
    VISIBLE "  The purrfect meowgical tree"
    VISIBLE "  (C) 2024 Cat Corp"
    VISIBLE "  License: MEOW-33-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "EXOTIC_SHORTHAIR BENCHMARKER"
      config HAS A version ITZ "34.7"
      config HAS A author ITZ "cat_6396"
      config HAS A license ITZ "MEOW-89-CAT"
      config HAS A description ITZ "The purrfect meowgical tree for all your cat needs"
      config HAS A cats_needed ITZ 60
      config HAS A treats_per_hour ITZ 6
      config HAS A nap_intervals ITZ 20
      config HAS A meow_volume ITZ "9"
      config HAS A purr_frequency ITZ 28
      VISIBLE "INITIALIZING EXOTIC_SHORTHAIR BENCHMARKER..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 13
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING EXOTIC_SHORTHAIR BENCHMARKER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "EXOTIC_SHORTHAIR BENCHMARKER SHUTTING DOWN... MEOW!"
