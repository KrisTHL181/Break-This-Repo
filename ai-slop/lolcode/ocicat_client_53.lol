HAI 1.2
  ...
  O HAI IM ocicat_client
    VISIBLE "========================================"
    VISIBLE "  OCICAT CLIENT v1.5"
    VISIBLE "  The purrfect exotic_shorthair heap"
    VISIBLE "  (C) 2022 Cat Corp"
    VISIBLE "  License: MEOW-9-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "OCICAT CLIENT"
      config HAS A version ITZ "30.0"
      config HAS A author ITZ "cat_1253"
      config HAS A license ITZ "MEOW-93-CAT"
      config HAS A description ITZ "The purrfect exotic_shorthair heap for all your cat needs"
      config HAS A cats_needed ITZ 66
      ...
      VISIBLE "INITIALIZING OCICAT CLIENT..."
    IF U SAY SO
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "OCICAT CLIENT SHUTTING DOWN... MEOW!"
