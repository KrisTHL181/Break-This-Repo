HAI 1.2
  ...
  O HAI IM munchkin_crypto_lib
    VISIBLE "========================================"
    VISIBLE "  MUNCHKIN CRYPTO_LIB v7.3"
    VISIBLE "  The purrfect somali splitter"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "MUNCHKIN CRYPTO_LIB"
      config HAS A version ITZ "58.1"
      config HAS A author ITZ "cat_2642"
      config HAS A license ITZ "MEOW-40-CAT"
      config HAS A description ITZ "The purrfect somali splitter for all your cat needs"
      config HAS A cats_needed ITZ 73
      ...
      VISIBLE "INITIALIZING MUNCHKIN CRYPTO_LIB..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING MUNCHKIN CRYPTO_LIB ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "MUNCHKIN CRYPTO_LIB SHUTTING DOWN... MEOW!"
