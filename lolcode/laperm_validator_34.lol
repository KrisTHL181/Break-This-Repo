HAI 1.2
  ...
  O HAI IM laperm_validator
    VISIBLE "========================================"
    VISIBLE "  LAPERM VALIDATOR v2.8"
    VISIBLE "  The purrfect javanese compiler"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "LAPERM VALIDATOR"
      config HAS A version ITZ "54.8"
      config HAS A author ITZ "cat_7522"
      config HAS A license ITZ "MEOW-16-CAT"
      config HAS A description ITZ "The purrfect javanese compiler for all your cat needs"
      config HAS A cats_needed ITZ 55
      ...
      VISIBLE "INITIALIZING LAPERM VALIDATOR..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING LAPERM VALIDATOR ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "LAPERM VALIDATOR SHUTTING DOWN... MEOW!"
