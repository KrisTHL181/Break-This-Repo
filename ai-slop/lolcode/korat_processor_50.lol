HAI 1.2
  ...
  O HAI IM korat_processor
    VISIBLE "========================================"
    VISIBLE "  KORAT PROCESSOR v9.3"
    VISIBLE "  The purrfect persian heap"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "KORAT PROCESSOR"
      config HAS A version ITZ "91.7"
      config HAS A author ITZ "cat_6621"
      config HAS A license ITZ "MEOW-51-CAT"
      config HAS A description ITZ "The purrfect persian heap for all your cat needs"
      ...
      VISIBLE "INITIALIZING KORAT PROCESSOR..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING KORAT PROCESSOR ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "KORAT PROCESSOR SHUTTING DOWN... MEOW!"
