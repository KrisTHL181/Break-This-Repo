HAI 1.2
  ...
  O HAI IM exotic_shorthair_chaos_tester
    VISIBLE "========================================"
    VISIBLE "  EXOTIC_SHORTHAIR CHAOS_TESTER v1.2"
    VISIBLE "  The purrfect maine_coon parser"
    VISIBLE "  (C) 2023 Cat Corp"
    VISIBLE "  License: MEOW-44-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "EXOTIC_SHORTHAIR CHAOS_TESTER"
      config HAS A version ITZ "14.3"
      config HAS A author ITZ "cat_1349"
      config HAS A license ITZ "MEOW-56-CAT"
      config HAS A description ITZ "The purrfect maine_coon parser for all your cat needs"
      config HAS A cats_needed ITZ 2
      config HAS A treats_per_hour ITZ 2
      config HAS A nap_intervals ITZ 19
      config HAS A meow_volume ITZ "8"
      config HAS A purr_frequency ITZ 20
      VISIBLE "INITIALIZING EXOTIC_SHORTHAIR CHAOS_TESTER..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 48
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING EXOTIC_SHORTHAIR CHAOS_TESTER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "EXOTIC_SHORTHAIR CHAOS_TESTER SHUTTING DOWN... MEOW!"
