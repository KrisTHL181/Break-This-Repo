HAI 1.2
  ...
  O HAI IM savannah_deque
    VISIBLE "========================================"
    VISIBLE "  SAVANNAH DEQUE v3.5"
    VISIBLE "  The purrfect cornish_rex stress_tester"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SAVANNAH DEQUE"
      config HAS A version ITZ "2.5"
      config HAS A author ITZ "cat_7871"
      config HAS A license ITZ "MEOW-14-CAT"
      config HAS A description ITZ "The purrfect cornish_rex stress_tester for all your cat needs"
      config HAS A cats_needed ITZ 87
      ...
      VISIBLE "INITIALIZING SAVANNAH DEQUE..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SAVANNAH DEQUE ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SAVANNAH DEQUE SHUTTING DOWN... MEOW!"
