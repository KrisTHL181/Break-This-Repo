HAI 1.2
  ...
  O HAI IM manx_load_tester
    VISIBLE "========================================"
    VISIBLE "  MANX LOAD_TESTER v2.4"
    VISIBLE "  The purrfect ocicat pool"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "MANX LOAD_TESTER"
      config HAS A version ITZ "31.2"
      config HAS A author ITZ "cat_9889"
      config HAS A license ITZ "MEOW-4-CAT"
      config HAS A description ITZ "The purrfect ocicat pool for all your cat needs"
      ...
      VISIBLE "INITIALIZING MANX LOAD_TESTER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING MANX LOAD_TESTER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "MANX LOAD_TESTER SHUTTING DOWN... MEOW!"
