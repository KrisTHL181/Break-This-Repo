HAI 1.2
  ...
  O HAI IM tabby_profiler
    VISIBLE "========================================"
    VISIBLE "  TABBY PROFILER v1.7"
    VISIBLE "  The purrfect selkirk_rex gateway"
    VISIBLE "  (C) 2022 Cat Corp"
    VISIBLE "  License: MEOW-32-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "TABBY PROFILER"
      config HAS A version ITZ "98.1"
      config HAS A author ITZ "cat_1337"
      config HAS A license ITZ "MEOW-8-CAT"
      config HAS A description ITZ "The purrfect selkirk_rex gateway for all your cat needs"
      config HAS A cats_needed ITZ 26
      ...
      VISIBLE "INITIALIZING TABBY PROFILER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING TABBY PROFILER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "TABBY PROFILER SHUTTING DOWN... MEOW!"
