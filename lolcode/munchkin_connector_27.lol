HAI 1.2
  ...
  O HAI IM munchkin_connector
    VISIBLE "========================================"
    VISIBLE "  MUNCHKIN CONNECTOR v4.2"
    VISIBLE "  The purrfect bengal gateway"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "MUNCHKIN CONNECTOR"
      config HAS A version ITZ "53.8"
      config HAS A author ITZ "cat_1699"
      config HAS A license ITZ "MEOW-81-CAT"
      config HAS A description ITZ "The purrfect bengal gateway for all your cat needs"
      config HAS A cats_needed ITZ 29
      config HAS A treats_per_hour ITZ 59
      config HAS A nap_intervals ITZ 13
      config HAS A meow_volume ITZ "10"
      config HAS A purr_frequency ITZ 33
      VISIBLE "INITIALIZING MUNCHKIN CONNECTOR..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING MUNCHKIN CONNECTOR ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "MUNCHKIN CONNECTOR SHUTTING DOWN... MEOW!"
