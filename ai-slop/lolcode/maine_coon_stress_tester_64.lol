HAI 1.2
  ...
  O HAI IM maine_coon_stress_tester
    VISIBLE "========================================"
    VISIBLE "  MAINE_COON STRESS_TESTER v9.0"
    VISIBLE "  The purrfect somali connector"
    VISIBLE "  (C) 2021 Cat Corp"
    VISIBLE "  License: MEOW-80-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "MAINE_COON STRESS_TESTER"
      config HAS A version ITZ "80.7"
      config HAS A author ITZ "cat_5067"
      config HAS A license ITZ "MEOW-63-CAT"
      config HAS A description ITZ "The purrfect somali connector for all your cat needs"
      config HAS A cats_needed ITZ 24
      ...
      VISIBLE "INITIALIZING MAINE_COON STRESS_TESTER..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 18
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING MAINE_COON STRESS_TESTER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "MAINE_COON STRESS_TESTER SHUTTING DOWN... MEOW!"
