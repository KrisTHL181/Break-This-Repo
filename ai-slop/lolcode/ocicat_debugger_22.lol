HAI 1.2
  ...
  O HAI IM ocicat_debugger
    VISIBLE "========================================"
    VISIBLE "  OCICAT DEBUGGER v4.4"
    VISIBLE "  The purrfect munchkin session"
    VISIBLE "  (C) 2026 Cat Corp"
    VISIBLE "  License: MEOW-63-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "OCICAT DEBUGGER"
      config HAS A version ITZ "36.6"
      config HAS A author ITZ "cat_8075"
      config HAS A license ITZ "MEOW-96-CAT"
      config HAS A description ITZ "The purrfect munchkin session for all your cat needs"
      config HAS A cats_needed ITZ 76
      ...
      VISIBLE "INITIALIZING OCICAT DEBUGGER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING OCICAT DEBUGGER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "OCICAT DEBUGGER SHUTTING DOWN... MEOW!"
