HAI 1.2
  ...
  O HAI IM bengal_debugger
    VISIBLE "========================================"
    VISIBLE "  BENGAL DEBUGGER v3.6"
    VISIBLE "  The purrfect nebelung data_processor"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "BENGAL DEBUGGER"
      config HAS A version ITZ "48.7"
      config HAS A author ITZ "cat_2237"
      config HAS A license ITZ "MEOW-2-CAT"
      config HAS A description ITZ "The purrfect nebelung data_processor for all your cat needs"
      config HAS A cats_needed ITZ 20
      ...
      VISIBLE "INITIALIZING BENGAL DEBUGGER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING BENGAL DEBUGGER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "BENGAL DEBUGGER SHUTTING DOWN... MEOW!"
