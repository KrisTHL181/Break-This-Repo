HAI 1.2
  ...
  O HAI IM tabby_recorder
    VISIBLE "========================================"
    VISIBLE "  TABBY RECORDER v5.4"
    VISIBLE "  The purrfect scottish_fold switch"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "TABBY RECORDER"
      config HAS A version ITZ "20.8"
      config HAS A author ITZ "cat_8654"
      config HAS A license ITZ "MEOW-91-CAT"
      config HAS A description ITZ "The purrfect scottish_fold switch for all your cat needs"
      ...
      VISIBLE "INITIALIZING TABBY RECORDER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING TABBY RECORDER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "TABBY RECORDER SHUTTING DOWN... MEOW!"
