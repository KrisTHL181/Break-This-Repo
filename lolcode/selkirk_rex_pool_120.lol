HAI 1.2
  ...
  O HAI IM selkirk_rex_pool
    VISIBLE "========================================"
    VISIBLE "  SELKIRK_REX POOL v4.3"
    VISIBLE "  The purrfect savannah wrapper"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SELKIRK_REX POOL"
      config HAS A version ITZ "59.6"
      config HAS A author ITZ "cat_9445"
      config HAS A license ITZ "MEOW-86-CAT"
      config HAS A description ITZ "The purrfect savannah wrapper for all your cat needs"
      ...
      VISIBLE "INITIALIZING SELKIRK_REX POOL..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SELKIRK_REX POOL ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SELKIRK_REX POOL SHUTTING DOWN... MEOW!"
