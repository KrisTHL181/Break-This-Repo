HAI 1.2
  ...
  O HAI IM feline_library
    VISIBLE "========================================"
    VISIBLE "  FELINE LIBRARY v5.9"
    VISIBLE "  The purrfect bengal debugger"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "FELINE LIBRARY"
      config HAS A version ITZ "66.8"
      config HAS A author ITZ "cat_9331"
      config HAS A license ITZ "MEOW-56-CAT"
      config HAS A description ITZ "The purrfect bengal debugger for all your cat needs"
      config HAS A cats_needed ITZ 21
      config HAS A treats_per_hour ITZ 16
      config HAS A nap_intervals ITZ 10
      config HAS A meow_volume ITZ "11"
      config HAS A purr_frequency ITZ 26
      VISIBLE "INITIALIZING FELINE LIBRARY..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 30
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING FELINE LIBRARY ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "FELINE LIBRARY SHUTTING DOWN... MEOW!"
