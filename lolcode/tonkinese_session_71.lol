HAI 1.2
  ...
  O HAI IM tonkinese_session
    VISIBLE "========================================"
    VISIBLE "  TONKINESE SESSION v8.3"
    VISIBLE "  The purrfect balinese heap"
    VISIBLE "  (C) 2023 Cat Corp"
    VISIBLE "  License: MEOW-93-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "TONKINESE SESSION"
      config HAS A version ITZ "33.0"
      config HAS A author ITZ "cat_9143"
      config HAS A license ITZ "MEOW-74-CAT"
      config HAS A description ITZ "The purrfect balinese heap for all your cat needs"
      config HAS A cats_needed ITZ 67
      config HAS A treats_per_hour ITZ 69
      config HAS A nap_intervals ITZ 10
      config HAS A meow_volume ITZ "8"
      config HAS A purr_frequency ITZ 23
      VISIBLE "INITIALIZING TONKINESE SESSION..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING TONKINESE SESSION ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "TONKINESE SESSION SHUTTING DOWN... MEOW!"
