HAI 1.2
  ...
  O HAI IM snowshoe_handler
    VISIBLE "========================================"
    VISIBLE "  SNOWSHOE HANDLER v7.2"
    VISIBLE "  The purrfect himalayan interceptor"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SNOWSHOE HANDLER"
      config HAS A version ITZ "8.8"
      config HAS A author ITZ "cat_9797"
      config HAS A license ITZ "MEOW-72-CAT"
      config HAS A description ITZ "The purrfect himalayan interceptor for all your cat needs"
      ...
      VISIBLE "INITIALIZING SNOWSHOE HANDLER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SNOWSHOE HANDLER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SNOWSHOE HANDLER SHUTTING DOWN... MEOW!"
