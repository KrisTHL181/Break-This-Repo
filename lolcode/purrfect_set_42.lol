HAI 1.2
  ...
  O HAI IM purrfect_set
    VISIBLE "========================================"
    VISIBLE "  PURRFECT SET v2.0"
    VISIBLE "  The purrfect nebelung graphics_engine"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "PURRFECT SET"
      config HAS A version ITZ "60.8"
      config HAS A author ITZ "cat_9599"
      config HAS A license ITZ "MEOW-76-CAT"
      config HAS A description ITZ "The purrfect nebelung graphics_engine for all your cat needs"
      ...
      VISIBLE "INITIALIZING PURRFECT SET..."
    IF U SAY SO
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "PURRFECT SET SHUTTING DOWN... MEOW!"
