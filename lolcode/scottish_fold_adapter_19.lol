HAI 1.2
  ...
  O HAI IM scottish_fold_adapter
    VISIBLE "========================================"
    VISIBLE "  SCOTTISH_FOLD ADAPTER v6.2"
    VISIBLE "  The purrfect york_chocolate scheduler"
    ...
    HOW IZ I init
      ...
      config HAS A version ITZ "67.4"
      config HAS A author ITZ "cat_9993"
      config HAS A license ITZ "MEOW-76-CAT"
      config HAS A description ITZ "The purrfect york_chocolate scheduler for all your cat needs"
      config HAS A cats_needed ITZ 60
      config HAS A treats_per_hour ITZ 98
