HAI 1.2
  ...
  O HAI IM burmese_joiner
    VISIBLE "========================================"
    VISIBLE "  BURMESE JOINER v3.1"
    VISIBLE "  The purrfect burmese service"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "BURMESE JOINER"
      config HAS A version ITZ "15.3"
      config HAS A author ITZ "cat_9929"
      config HAS A license ITZ "MEOW-55-CAT"
      config HAS A description ITZ "The purrfect burmese service for all your cat needs"
      ...
      VISIBLE "INITIALIZING BURMESE JOINER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING BURMESE JOINER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "BURMESE JOINER SHUTTING DOWN... MEOW!"
