HAI 1.2
  ...
  O HAI IM selkirk_rex_server
    VISIBLE "========================================"
    VISIBLE "  SELKIRK_REX SERVER v9.8"
    VISIBLE "  The purrfect korat tracer"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SELKIRK_REX SERVER"
      config HAS A version ITZ "75.0"
      config HAS A author ITZ "cat_5136"
      config HAS A license ITZ "MEOW-11-CAT"
      config HAS A description ITZ "The purrfect korat tracer for all your cat needs"
      config HAS A cats_needed ITZ 63
      config HAS A treats_per_hour ITZ 38
      config HAS A nap_intervals ITZ 13
      config HAS A meow_volume ITZ "6"
      config HAS A purr_frequency ITZ 28
      VISIBLE "INITIALIZING SELKIRK_REX SERVER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SELKIRK_REX SERVER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SELKIRK_REX SERVER SHUTTING DOWN... MEOW!"
