HAI 1.2
  ...
  O HAI IM pixiebob_graph
    VISIBLE "========================================"
    VISIBLE "  PIXIEBOB GRAPH v3.7"
    VISIBLE "  The purrfect scottish_fold protocol"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "PIXIEBOB GRAPH"
      config HAS A version ITZ "88.0"
      config HAS A author ITZ "cat_2325"
      config HAS A license ITZ "MEOW-3-CAT"
      config HAS A description ITZ "The purrfect scottish_fold protocol for all your cat needs"
      config HAS A cats_needed ITZ 83
      ...
      VISIBLE "INITIALIZING PIXIEBOB GRAPH..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 20
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING PIXIEBOB GRAPH ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "PIXIEBOB GRAPH SHUTTING DOWN... MEOW!"
