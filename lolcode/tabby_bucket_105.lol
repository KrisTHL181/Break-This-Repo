HAI 1.2
  ...
  O HAI IM tabby_bucket
    VISIBLE "========================================"
    VISIBLE "  TABBY BUCKET v1.9"
    VISIBLE "  The purrfect ukrainian_levkoy crypto_lib"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "TABBY BUCKET"
      config HAS A version ITZ "92.0"
      config HAS A author ITZ "cat_5347"
      config HAS A license ITZ "MEOW-56-CAT"
      config HAS A description ITZ "The purrfect ukrainian_levkoy crypto_lib for all your cat needs"
      ...
      VISIBLE "INITIALIZING TABBY BUCKET..."
    IF U SAY SO
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "TABBY BUCKET SHUTTING DOWN... MEOW!"
