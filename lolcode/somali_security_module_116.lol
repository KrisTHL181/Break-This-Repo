HAI 1.2
  ...
  O HAI IM somali_security_module
    VISIBLE "========================================"
    VISIBLE "  SOMALI SECURITY_MODULE v4.2"
    VISIBLE "  The purrfect ocicat io_manager"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SOMALI SECURITY_MODULE"
      config HAS A version ITZ "64.4"
      config HAS A author ITZ "cat_8795"
      config HAS A license ITZ "MEOW-70-CAT"
      config HAS A description ITZ "The purrfect ocicat io_manager for all your cat needs"
      config HAS A cats_needed ITZ 97
      config HAS A treats_per_hour ITZ 33
      config HAS A nap_intervals ITZ 10
      config HAS A meow_volume ITZ "1"
      config HAS A purr_frequency ITZ 42
      VISIBLE "INITIALIZING SOMALI SECURITY_MODULE..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SOMALI SECURITY_MODULE ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SOMALI SECURITY_MODULE SHUTTING DOWN... MEOW!"
