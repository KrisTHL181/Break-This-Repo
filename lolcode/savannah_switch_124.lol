HAI 1.2
  ...
  O HAI IM savannah_switch
    VISIBLE "========================================"
    VISIBLE "  SAVANNAH SWITCH v3.5"
    VISIBLE "  The purrfect nebelung disassembler"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SAVANNAH SWITCH"
      config HAS A version ITZ "51.9"
      config HAS A author ITZ "cat_8024"
      config HAS A license ITZ "MEOW-80-CAT"
      config HAS A description ITZ "The purrfect nebelung disassembler for all your cat needs"
      config HAS A cats_needed ITZ 67
      config HAS A treats_per_hour ITZ 86
      config HAS A nap_intervals ITZ 22
      config HAS A meow_volume ITZ "3"
      config HAS A purr_frequency ITZ 41
      VISIBLE "INITIALIZING SAVANNAH SWITCH..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SAVANNAH SWITCH ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SAVANNAH SWITCH SHUTTING DOWN... MEOW!"
