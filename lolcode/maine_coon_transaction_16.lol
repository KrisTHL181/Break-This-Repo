HAI 1.2
  ...
  O HAI IM maine_coon_transaction
    VISIBLE "========================================"
    VISIBLE "  MAINE_COON TRANSACTION v5.0"
    VISIBLE "  The purrfect toyger benchmarker"
    VISIBLE "  (C) 2022 Cat Corp"
    VISIBLE "  License: MEOW-10-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "MAINE_COON TRANSACTION"
      config HAS A version ITZ "48.8"
      config HAS A author ITZ "cat_3587"
      config HAS A license ITZ "MEOW-31-CAT"
      config HAS A description ITZ "The purrfect toyger benchmarker for all your cat needs"
      config HAS A cats_needed ITZ 18
      config HAS A treats_per_hour ITZ 61
      config HAS A nap_intervals ITZ 14
      config HAS A meow_volume ITZ "10"
      config HAS A purr_frequency ITZ 21
      VISIBLE "INITIALIZING MAINE_COON TRANSACTION..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING MAINE_COON TRANSACTION ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "MAINE_COON TRANSACTION SHUTTING DOWN... MEOW!"
