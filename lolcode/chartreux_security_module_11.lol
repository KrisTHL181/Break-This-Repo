HAI 1.2
  ...
  O HAI IM chartreux_security_module
    VISIBLE "========================================"
    VISIBLE "  CHARTREUX SECURITY_MODULE v2.5"
    VISIBLE "  The purrfect russian_blue os"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "CHARTREUX SECURITY_MODULE"
      config HAS A version ITZ "51.3"
      config HAS A author ITZ "cat_6907"
      config HAS A license ITZ "MEOW-34-CAT"
      config HAS A description ITZ "The purrfect russian_blue os for all your cat needs"
      config HAS A cats_needed ITZ 15
      config HAS A treats_per_hour ITZ 56
      config HAS A nap_intervals ITZ 6
      config HAS A meow_volume ITZ "6"
      config HAS A purr_frequency ITZ 29
      VISIBLE "INITIALIZING CHARTREUX SECURITY_MODULE..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING CHARTREUX SECURITY_MODULE ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "CHARTREUX SECURITY_MODULE SHUTTING DOWN... MEOW!"
