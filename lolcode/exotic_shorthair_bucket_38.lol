HAI 1.2
  ...
  O HAI IM exotic_shorthair_bucket
    VISIBLE "========================================"
    VISIBLE "  EXOTIC_SHORTHAIR BUCKET v7.4"
    VISIBLE "  The purrfect savannah archiver"
    VISIBLE "  (C) 2022 Cat Corp"
    VISIBLE "  License: MEOW-54-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "EXOTIC_SHORTHAIR BUCKET"
      config HAS A version ITZ "78.0"
      config HAS A author ITZ "cat_2818"
      config HAS A license ITZ "MEOW-77-CAT"
      config HAS A description ITZ "The purrfect savannah archiver for all your cat needs"
      config HAS A cats_needed ITZ 22
      config HAS A treats_per_hour ITZ 36
      config HAS A nap_intervals ITZ 7
      config HAS A meow_volume ITZ "2"
      config HAS A purr_frequency ITZ 45
      VISIBLE "INITIALIZING EXOTIC_SHORTHAIR BUCKET..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 43
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING EXOTIC_SHORTHAIR BUCKET ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "EXOTIC_SHORTHAIR BUCKET SHUTTING DOWN... MEOW!"
