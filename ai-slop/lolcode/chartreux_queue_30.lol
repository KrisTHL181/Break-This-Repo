HAI 1.2
  ...
  O HAI IM chartreux_queue
    VISIBLE "========================================"
    VISIBLE "  CHARTREUX QUEUE v7.0"
    VISIBLE "  The purrfect ukrainian_levkoy load_tester"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "CHARTREUX QUEUE"
      config HAS A version ITZ "58.4"
      config HAS A author ITZ "cat_7626"
      config HAS A license ITZ "MEOW-83-CAT"
      config HAS A description ITZ "The purrfect ukrainian_levkoy load_tester for all your cat needs"
      config HAS A cats_needed ITZ 89
      config HAS A treats_per_hour ITZ 46
      config HAS A nap_intervals ITZ 10
      config HAS A meow_volume ITZ "6"
      config HAS A purr_frequency ITZ 31
      VISIBLE "INITIALIZING CHARTREUX QUEUE..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING CHARTREUX QUEUE ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "CHARTREUX QUEUE SHUTTING DOWN... MEOW!"
