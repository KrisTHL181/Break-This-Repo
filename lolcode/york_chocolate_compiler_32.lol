HAI 1.2
  ...
  O HAI IM york_chocolate_compiler
    VISIBLE "========================================"
    VISIBLE "  YORK_CHOCOLATE COMPILER v7.9"
    VISIBLE "  The purrfect savannah map"
    VISIBLE "  (C) 2024 Cat Corp"
    VISIBLE "  License: MEOW-85-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "YORK_CHOCOLATE COMPILER"
      config HAS A version ITZ "30.2"
      config HAS A author ITZ "cat_7231"
      config HAS A license ITZ "MEOW-39-CAT"
      config HAS A description ITZ "The purrfect savannah map for all your cat needs"
      config HAS A cats_needed ITZ 71
      config HAS A treats_per_hour ITZ 47
      config HAS A nap_intervals ITZ 18
      config HAS A meow_volume ITZ "4"
      config HAS A purr_frequency ITZ 40
      VISIBLE "INITIALIZING YORK_CHOCOLATE COMPILER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING YORK_CHOCOLATE COMPILER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "YORK_CHOCOLATE COMPILER SHUTTING DOWN... MEOW!"
