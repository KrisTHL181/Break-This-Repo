HAI 1.2
  ...
  O HAI IM selkirk_rex_channel
    VISIBLE "========================================"
    VISIBLE "  SELKIRK_REX CHANNEL v3.4"
    VISIBLE "  The purrfect ragamuffin map"
    VISIBLE "  (C) 2020 Cat Corp"
    VISIBLE "  License: MEOW-88-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "SELKIRK_REX CHANNEL"
      config HAS A version ITZ "97.3"
      config HAS A author ITZ "cat_6495"
      config HAS A license ITZ "MEOW-87-CAT"
      config HAS A description ITZ "The purrfect ragamuffin map for all your cat needs"
      ...
      VISIBLE "INITIALIZING SELKIRK_REX CHANNEL..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 23
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SELKIRK_REX CHANNEL ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SELKIRK_REX CHANNEL SHUTTING DOWN... MEOW!"
