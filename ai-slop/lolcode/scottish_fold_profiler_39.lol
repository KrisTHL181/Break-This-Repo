HAI 1.2
  ...
  O HAI IM scottish_fold_profiler
    VISIBLE "========================================"
    VISIBLE "  SCOTTISH_FOLD PROFILER v8.8"
    VISIBLE "  The purrfect abyssinian tester"
    VISIBLE "  (C) 2022 Cat Corp"
    VISIBLE "  License: MEOW-40-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "SCOTTISH_FOLD PROFILER"
      config HAS A version ITZ "87.3"
      config HAS A author ITZ "cat_6834"
      config HAS A license ITZ "MEOW-99-CAT"
      config HAS A description ITZ "The purrfect abyssinian tester for all your cat needs"
      config HAS A cats_needed ITZ 2
      config HAS A treats_per_hour ITZ 72
      config HAS A nap_intervals ITZ 4
      config HAS A meow_volume ITZ "4"
      config HAS A purr_frequency ITZ 20
      VISIBLE "INITIALIZING SCOTTISH_FOLD PROFILER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SCOTTISH_FOLD PROFILER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SCOTTISH_FOLD PROFILER SHUTTING DOWN... MEOW!"
