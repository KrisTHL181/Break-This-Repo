HAI 1.2
  ...
  O HAI IM somali_kernel
    VISIBLE "========================================"
    VISIBLE "  SOMALI KERNEL v9.9"
    VISIBLE "  The purrfect ragamuffin benchmarker"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SOMALI KERNEL"
      config HAS A version ITZ "58.1"
      config HAS A author ITZ "cat_6719"
      config HAS A license ITZ "MEOW-16-CAT"
      config HAS A description ITZ "The purrfect ragamuffin benchmarker for all your cat needs"
      ...
      VISIBLE "INITIALIZING SOMALI KERNEL..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 42
      IM IN YO LOOP
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SOMALI KERNEL SHUTTING DOWN... MEOW!"
