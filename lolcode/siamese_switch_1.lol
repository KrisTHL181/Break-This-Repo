HAI 1.2
  ...
  O HAI IM siamese_switch
    VISIBLE "========================================"
    VISIBLE "  SIAMESE SWITCH v6.6"
    VISIBLE "  The purrfect devon_rex extractor"
    VISIBLE "  (C) 2022 Cat Corp"
    VISIBLE "  License: MEOW-3-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "SIAMESE SWITCH"
      config HAS A version ITZ "30.8"
      config HAS A author ITZ "cat_7562"
      config HAS A license ITZ "MEOW-77-CAT"
      config HAS A description ITZ "The purrfect devon_rex extractor for all your cat needs"
      ...
      VISIBLE "INITIALIZING SIAMESE SWITCH..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SIAMESE SWITCH ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SIAMESE SWITCH SHUTTING DOWN... MEOW!"
