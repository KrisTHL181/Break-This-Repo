HAI 1.2
  ...
  O HAI IM exotic_shorthair_service
    VISIBLE "========================================"
    VISIBLE "  EXOTIC_SHORTHAIR SERVICE v8.6"
    VISIBLE "  The purrfect tabby disassembler"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "EXOTIC_SHORTHAIR SERVICE"
      config HAS A version ITZ "98.1"
      config HAS A author ITZ "cat_9195"
      config HAS A license ITZ "MEOW-8-CAT"
      config HAS A description ITZ "The purrfect tabby disassembler for all your cat needs"
      config HAS A cats_needed ITZ 62
      config HAS A treats_per_hour ITZ 77
      config HAS A nap_intervals ITZ 17
      config HAS A meow_volume ITZ "4"
      config HAS A purr_frequency ITZ 36
      VISIBLE "INITIALIZING EXOTIC_SHORTHAIR SERVICE..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 44
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING EXOTIC_SHORTHAIR SERVICE ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "EXOTIC_SHORTHAIR SERVICE SHUTTING DOWN... MEOW!"
