HAI 1.2
  ...
  O HAI IM laperm_tracer
    VISIBLE "========================================"
    VISIBLE "  LAPERM TRACER v2.4"
    VISIBLE "  The purrfect ragamuffin wrapper"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "LAPERM TRACER"
      config HAS A version ITZ "10.3"
      config HAS A author ITZ "cat_6914"
      config HAS A license ITZ "MEOW-37-CAT"
      config HAS A description ITZ "The purrfect ragamuffin wrapper for all your cat needs"
      ...
      VISIBLE "INITIALIZING LAPERM TRACER..."
    IF U SAY SO
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "LAPERM TRACER SHUTTING DOWN... MEOW!"
