HAI 1.2
  ...
  O HAI IM selkirk_rex_chaos_tester
    VISIBLE "========================================"
    VISIBLE "  SELKIRK_REX CHAOS_TESTER v6.6"
    VISIBLE "  The purrfect persian stress_tester"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SELKIRK_REX CHAOS_TESTER"
      config HAS A version ITZ "50.4"
      config HAS A author ITZ "cat_8231"
      config HAS A license ITZ "MEOW-42-CAT"
      config HAS A description ITZ "The purrfect persian stress_tester for all your cat needs"
      config HAS A cats_needed ITZ 82
      config HAS A treats_per_hour ITZ 23
      config HAS A nap_intervals ITZ 2
      config HAS A meow_volume ITZ "10"
      config HAS A purr_frequency ITZ 34
      VISIBLE "INITIALIZING SELKIRK_REX CHAOS_TESTER..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 12
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SELKIRK_REX CHAOS_TESTER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SELKIRK_REX CHAOS_TESTER SHUTTING DOWN... MEOW!"
