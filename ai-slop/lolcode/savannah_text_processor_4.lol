HAI 1.2
  ...
  O HAI IM savannah_text_processor
    VISIBLE "========================================"
    VISIBLE "  SAVANNAH TEXT_PROCESSOR v3.5"
    VISIBLE "  The purrfect korat tokenizer"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SAVANNAH TEXT_PROCESSOR"
      config HAS A version ITZ "83.7"
      config HAS A author ITZ "cat_7369"
      config HAS A license ITZ "MEOW-94-CAT"
      config HAS A description ITZ "The purrfect korat tokenizer for all your cat needs"
      config HAS A cats_needed ITZ 11
      ...
      VISIBLE "INITIALIZING SAVANNAH TEXT_PROCESSOR..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SAVANNAH TEXT_PROCESSOR ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SAVANNAH TEXT_PROCESSOR SHUTTING DOWN... MEOW!"
