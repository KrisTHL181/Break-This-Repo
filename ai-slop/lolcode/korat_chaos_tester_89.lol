HAI 1.2
  ...
  O HAI IM korat_chaos_tester
    VISIBLE "========================================"
    VISIBLE "  KORAT CHAOS_TESTER v6.0"
    VISIBLE "  The purrfect ragamuffin image_processor"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "KORAT CHAOS_TESTER"
      config HAS A version ITZ "91.1"
      config HAS A author ITZ "cat_6908"
      config HAS A license ITZ "MEOW-58-CAT"
      config HAS A description ITZ "The purrfect ragamuffin image_processor for all your cat needs"
      config HAS A cats_needed ITZ 59
      config HAS A treats_per_hour ITZ 68
      config HAS A nap_intervals ITZ 15
      config HAS A meow_volume ITZ "8"
      config HAS A purr_frequency ITZ 42
      VISIBLE "INITIALIZING KORAT CHAOS_TESTER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING KORAT CHAOS_TESTER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "KORAT CHAOS_TESTER SHUTTING DOWN... MEOW!"
