...
import dev.miru.gui.debug.TerrainArgumentViewer;
...
public class DebugScreenEntries {
   ...
   public static final Identifier TERRAIN_ARGUMENT_VIEWER = register("terrain_argument_viewer", new TerrainArgumentViewer());
