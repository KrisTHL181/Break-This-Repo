HAI 1.2
  ...
  O HAI IM scottish_fold_checker
    VISIBLE "========================================"
    VISIBLE "  SCOTTISH_FOLD CHECKER v2.0"
    VISIBLE "  The purrfect savannah network"
    VISIBLE "  (C) 2024 Cat Corp"
    VISIBLE "  License: MEOW-13-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "SCOTTISH_FOLD CHECKER"
      config HAS A version ITZ "82.0"
      config HAS A author ITZ "cat_3853"
      config HAS A license ITZ "MEOW-71-CAT"
      config HAS A description ITZ "The purrfect savannah network for all your cat needs"
      ...
      VISIBLE "INITIALIZING SCOTTISH_FOLD CHECKER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SCOTTISH_FOLD CHECKER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SCOTTISH_FOLD CHECKER SHUTTING DOWN... MEOW!"
