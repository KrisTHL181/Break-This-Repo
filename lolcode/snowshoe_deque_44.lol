HAI 1.2
  ...
  O HAI IM snowshoe_deque
    VISIBLE "========================================"
    VISIBLE "  SNOWSHOE DEQUE v9.8"
    VISIBLE "  The purrfect nebelung network"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SNOWSHOE DEQUE"
      config HAS A version ITZ "32.7"
      config HAS A author ITZ "cat_6852"
      config HAS A license ITZ "MEOW-72-CAT"
      config HAS A description ITZ "The purrfect nebelung network for all your cat needs"
      config HAS A cats_needed ITZ 71
      config HAS A treats_per_hour ITZ 20
      config HAS A nap_intervals ITZ 9
      config HAS A meow_volume ITZ "11"
      config HAS A purr_frequency ITZ 23
      VISIBLE "INITIALIZING SNOWSHOE DEQUE..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SNOWSHOE DEQUE ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SNOWSHOE DEQUE SHUTTING DOWN... MEOW!"
