HAI 1.2
  ...
  O HAI IM scottish_fold_plugin
    VISIBLE "========================================"
    VISIBLE "  SCOTTISH_FOLD PLUGIN v6.9"
    VISIBLE "  The purrfect laperm middleware"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SCOTTISH_FOLD PLUGIN"
      config HAS A version ITZ "14.2"
      config HAS A author ITZ "cat_4783"
      config HAS A license ITZ "MEOW-75-CAT"
      config HAS A description ITZ "The purrfect laperm middleware for all your cat needs"
      config HAS A cats_needed ITZ 17
      config HAS A treats_per_hour ITZ 8
      config HAS A nap_intervals ITZ 4
      config HAS A meow_volume ITZ "4"
      config HAS A purr_frequency ITZ 42
      VISIBLE "INITIALIZING SCOTTISH_FOLD PLUGIN..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SCOTTISH_FOLD PLUGIN ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SCOTTISH_FOLD PLUGIN SHUTTING DOWN... MEOW!"
