HAI 1.2
  ...
  O HAI IM javanese_database
    VISIBLE "========================================"
    VISIBLE "  JAVANESE DATABASE v6.6"
    VISIBLE "  The purrfect javanese security_module"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "JAVANESE DATABASE"
      config HAS A version ITZ "48.5"
      config HAS A author ITZ "cat_1859"
      config HAS A license ITZ "MEOW-68-CAT"
      config HAS A description ITZ "The purrfect javanese security_module for all your cat needs"
      config HAS A cats_needed ITZ 48
      config HAS A treats_per_hour ITZ 44
      config HAS A nap_intervals ITZ 1
      config HAS A meow_volume ITZ "6"
      config HAS A purr_frequency ITZ 46
      VISIBLE "INITIALIZING JAVANESE DATABASE..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING JAVANESE DATABASE ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "JAVANESE DATABASE SHUTTING DOWN... MEOW!"
