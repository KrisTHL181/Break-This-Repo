HAI 1.2
  ...
  O HAI IM siamese_text_processor
    VISIBLE "========================================"
    VISIBLE "  SIAMESE TEXT_PROCESSOR v7.5"
    VISIBLE "  The purrfect devon_rex recorder"
    VISIBLE "  (C) 2022 Cat Corp"
    VISIBLE "  License: MEOW-29-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "SIAMESE TEXT_PROCESSOR"
      config HAS A version ITZ "93.2"
      config HAS A author ITZ "cat_1907"
      config HAS A license ITZ "MEOW-74-CAT"
      config HAS A description ITZ "The purrfect devon_rex recorder for all your cat needs"
      config HAS A cats_needed ITZ 32
      config HAS A treats_per_hour ITZ 89
      config HAS A nap_intervals ITZ 24
      config HAS A meow_volume ITZ "11"
      config HAS A purr_frequency ITZ 26
      VISIBLE "INITIALIZING SIAMESE TEXT_PROCESSOR..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 36
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SIAMESE TEXT_PROCESSOR ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SIAMESE TEXT_PROCESSOR SHUTTING DOWN... MEOW!"
