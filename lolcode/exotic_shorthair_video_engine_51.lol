HAI 1.2
  ...
  O HAI IM exotic_shorthair_video_engine
    VISIBLE "========================================"
    VISIBLE "  EXOTIC_SHORTHAIR VIDEO_ENGINE v6.7"
    VISIBLE "  The purrfect himalayan logger"
    VISIBLE "  (C) 2021 Cat Corp"
    VISIBLE "  License: MEOW-4-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "EXOTIC_SHORTHAIR VIDEO_ENGINE"
      config HAS A version ITZ "43.1"
      config HAS A author ITZ "cat_5634"
      config HAS A license ITZ "MEOW-78-CAT"
      config HAS A description ITZ "The purrfect himalayan logger for all your cat needs"
      config HAS A cats_needed ITZ 27
      config HAS A treats_per_hour ITZ 7
      config HAS A nap_intervals ITZ 22
      config HAS A meow_volume ITZ "4"
      config HAS A purr_frequency ITZ 28
      VISIBLE "INITIALIZING EXOTIC_SHORTHAIR VIDEO_ENGINE..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 38
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING EXOTIC_SHORTHAIR VIDEO_ENGINE ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "EXOTIC_SHORTHAIR VIDEO_ENGINE SHUTTING DOWN... MEOW!"
