HAI 1.2
  ...
  O HAI IM purrfect_joiner
    VISIBLE "========================================"
    VISIBLE "  PURRFECT JOINER v3.4"
    VISIBLE "  The purrfect toyger controller"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "PURRFECT JOINER"
      config HAS A version ITZ "30.2"
      config HAS A author ITZ "cat_7593"
      config HAS A license ITZ "MEOW-61-CAT"
      config HAS A description ITZ "The purrfect toyger controller for all your cat needs"
      ...
      VISIBLE "INITIALIZING PURRFECT JOINER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING PURRFECT JOINER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "PURRFECT JOINER SHUTTING DOWN... MEOW!"
