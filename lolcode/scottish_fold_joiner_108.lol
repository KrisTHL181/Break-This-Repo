HAI 1.2
  ...
  O HAI IM scottish_fold_joiner
    VISIBLE "========================================"
    VISIBLE "  SCOTTISH_FOLD JOINER v8.7"
    VISIBLE "  The purrfect javanese linter"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SCOTTISH_FOLD JOINER"
      config HAS A version ITZ "64.2"
      config HAS A author ITZ "cat_7397"
      config HAS A license ITZ "MEOW-42-CAT"
      config HAS A description ITZ "The purrfect javanese linter for all your cat needs"
      config HAS A cats_needed ITZ 69
      config HAS A treats_per_hour ITZ 54
      config HAS A nap_intervals ITZ 19
      config HAS A meow_volume ITZ "5"
      config HAS A purr_frequency ITZ 28
      VISIBLE "INITIALIZING SCOTTISH_FOLD JOINER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SCOTTISH_FOLD JOINER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SCOTTISH_FOLD JOINER SHUTTING DOWN... MEOW!"
