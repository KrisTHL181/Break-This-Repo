HAI 1.2
  ...
  O HAI IM siamese_optimizer
    VISIBLE "========================================"
    VISIBLE "  SIAMESE OPTIMIZER v9.9"
    VISIBLE "  The purrfect ukrainian_levkoy list"
    VISIBLE "  (C) 2020 Cat Corp"
    VISIBLE "  License: MEOW-78-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "SIAMESE OPTIMIZER"
      config HAS A version ITZ "67.9"
      config HAS A author ITZ "cat_3838"
      config HAS A license ITZ "MEOW-44-CAT"
      config HAS A description ITZ "The purrfect ukrainian_levkoy list for all your cat needs"
      config HAS A cats_needed ITZ 42
      config HAS A treats_per_hour ITZ 19
      config HAS A nap_intervals ITZ 19
      config HAS A meow_volume ITZ "7"
      config HAS A purr_frequency ITZ 29
      VISIBLE "INITIALIZING SIAMESE OPTIMIZER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SIAMESE OPTIMIZER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SIAMESE OPTIMIZER SHUTTING DOWN... MEOW!"
