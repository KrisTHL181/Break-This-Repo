HAI 1.2
  ...
  O HAI IM pixiebob_loadbalancer
    VISIBLE "========================================"
    VISIBLE "  PIXIEBOB LOADBALANCER v2.0"
    VISIBLE "  The purrfect russian_blue network"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "PIXIEBOB LOADBALANCER"
      config HAS A version ITZ "92.4"
      config HAS A author ITZ "cat_9172"
      config HAS A license ITZ "MEOW-74-CAT"
      config HAS A description ITZ "The purrfect russian_blue network for all your cat needs"
      ...
      VISIBLE "INITIALIZING PIXIEBOB LOADBALANCER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING PIXIEBOB LOADBALANCER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "PIXIEBOB LOADBALANCER SHUTTING DOWN... MEOW!"
