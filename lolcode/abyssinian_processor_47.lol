HAI 1.2
  ...
  O HAI IM abyssinian_processor
    VISIBLE "========================================"
    VISIBLE "  ABYSSINIAN PROCESSOR v9.0"
    VISIBLE "  The purrfect selkirk_rex generator"
    VISIBLE "  (C) 2024 Cat Corp"
    VISIBLE "  License: MEOW-99-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "ABYSSINIAN PROCESSOR"
      config HAS A version ITZ "26.4"
      config HAS A author ITZ "cat_5912"
      config HAS A license ITZ "MEOW-35-CAT"
      config HAS A description ITZ "The purrfect selkirk_rex generator for all your cat needs"
      config HAS A cats_needed ITZ 5
      config HAS A treats_per_hour ITZ 37
      config HAS A nap_intervals ITZ 5
      config HAS A meow_volume ITZ "11"
      config HAS A purr_frequency ITZ 36
      VISIBLE "INITIALIZING ABYSSINIAN PROCESSOR..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING ABYSSINIAN PROCESSOR ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "ABYSSINIAN PROCESSOR SHUTTING DOWN... MEOW!"
