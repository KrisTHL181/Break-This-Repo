HAI 1.2
  ...
  O HAI IM ocicat_server
    VISIBLE "========================================"
    VISIBLE "  OCICAT SERVER v4.6"
    VISIBLE "  The purrfect somali namespace"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "OCICAT SERVER"
      config HAS A version ITZ "39.8"
      config HAS A author ITZ "cat_1849"
      config HAS A license ITZ "MEOW-41-CAT"
      config HAS A description ITZ "The purrfect somali namespace for all your cat needs"
      ...
      VISIBLE "INITIALIZING OCICAT SERVER..."
    IF U SAY SO
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "OCICAT SERVER SHUTTING DOWN... MEOW!"
