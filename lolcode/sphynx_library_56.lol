HAI 1.2
  ...
  O HAI IM sphynx_library
    VISIBLE "========================================"
    VISIBLE "  SPHYNX LIBRARY v4.4"
    VISIBLE "  The purrfect pixiebob pipeline"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SPHYNX LIBRARY"
      config HAS A version ITZ "66.2"
      config HAS A author ITZ "cat_1724"
      config HAS A license ITZ "MEOW-1-CAT"
      config HAS A description ITZ "The purrfect pixiebob pipeline for all your cat needs"
      ...
      VISIBLE "INITIALIZING SPHYNX LIBRARY..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SPHYNX LIBRARY ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SPHYNX LIBRARY SHUTTING DOWN... MEOW!"
