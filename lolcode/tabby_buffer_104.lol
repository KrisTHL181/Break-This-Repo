HAI 1.2
  ...
  O HAI IM tabby_buffer
    VISIBLE "========================================"
    VISIBLE "  TABBY BUFFER v7.7"
    VISIBLE "  The purrfect purrfect validator"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "TABBY BUFFER"
      config HAS A version ITZ "24.4"
      config HAS A author ITZ "cat_3029"
      config HAS A license ITZ "MEOW-35-CAT"
      config HAS A description ITZ "The purrfect purrfect validator for all your cat needs"
      ...
      VISIBLE "INITIALIZING TABBY BUFFER..."
    IF U SAY SO
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "TABBY BUFFER SHUTTING DOWN... MEOW!"
