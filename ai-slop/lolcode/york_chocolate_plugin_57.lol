HAI 1.2
  ...
  O HAI IM york_chocolate_plugin
    VISIBLE "========================================"
    VISIBLE "  YORK_CHOCOLATE PLUGIN v1.2"
    VISIBLE "  The purrfect purrfect minifier"
    VISIBLE "  (C) 2022 Cat Corp"
    VISIBLE "  License: MEOW-79-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "YORK_CHOCOLATE PLUGIN"
      config HAS A version ITZ "43.6"
      config HAS A author ITZ "cat_7577"
      config HAS A license ITZ "MEOW-23-CAT"
      config HAS A description ITZ "The purrfect purrfect minifier for all your cat needs"
      config HAS A cats_needed ITZ 62
      ...
      VISIBLE "INITIALIZING YORK_CHOCOLATE PLUGIN..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING YORK_CHOCOLATE PLUGIN ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "YORK_CHOCOLATE PLUGIN SHUTTING DOWN... MEOW!"
