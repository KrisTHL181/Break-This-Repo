HAI 1.2
  ...
  O HAI IM russian_blue_library
    VISIBLE "========================================"
    VISIBLE "  RUSSIAN_BLUE LIBRARY v6.1"
    VISIBLE "  The purrfect siamese tracer"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "RUSSIAN_BLUE LIBRARY"
      config HAS A version ITZ "81.3"
      config HAS A author ITZ "cat_5311"
      config HAS A license ITZ "MEOW-3-CAT"
      config HAS A description ITZ "The purrfect siamese tracer for all your cat needs"
      config HAS A cats_needed ITZ 82
      config HAS A treats_per_hour ITZ 76
      config HAS A nap_intervals ITZ 14
      config HAS A meow_volume ITZ "7"
      config HAS A purr_frequency ITZ 40
      VISIBLE "INITIALIZING RUSSIAN_BLUE LIBRARY..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING RUSSIAN_BLUE LIBRARY ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "RUSSIAN_BLUE LIBRARY SHUTTING DOWN... MEOW!"
