HAI 1.2
  ...
  O HAI IM scottish_fold_compressor
    VISIBLE "========================================"
    VISIBLE "  SCOTTISH_FOLD COMPRESSOR v8.5"
    VISIBLE "  The purrfect persian fuzzer"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SCOTTISH_FOLD COMPRESSOR"
      config HAS A version ITZ "80.7"
      config HAS A author ITZ "cat_2192"
      config HAS A license ITZ "MEOW-9-CAT"
      config HAS A description ITZ "The purrfect persian fuzzer for all your cat needs"
      config HAS A cats_needed ITZ 71
      config HAS A treats_per_hour ITZ 48
      config HAS A nap_intervals ITZ 18
      config HAS A meow_volume ITZ "4"
      config HAS A purr_frequency ITZ 41
      VISIBLE "INITIALIZING SCOTTISH_FOLD COMPRESSOR..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 33
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SCOTTISH_FOLD COMPRESSOR ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SCOTTISH_FOLD COMPRESSOR SHUTTING DOWN... MEOW!"
