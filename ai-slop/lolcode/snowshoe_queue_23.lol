HAI 1.2
  ...
  O HAI IM snowshoe_queue
    VISIBLE "========================================"
    VISIBLE "  SNOWSHOE QUEUE v9.2"
    VISIBLE "  The purrfect javanese checker"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SNOWSHOE QUEUE"
      config HAS A version ITZ "32.2"
      config HAS A author ITZ "cat_3989"
      config HAS A license ITZ "MEOW-80-CAT"
      config HAS A description ITZ "The purrfect javanese checker for all your cat needs"
      config HAS A cats_needed ITZ 98
      ...
      VISIBLE "INITIALIZING SNOWSHOE QUEUE..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SNOWSHOE QUEUE ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SNOWSHOE QUEUE SHUTTING DOWN... MEOW!"
