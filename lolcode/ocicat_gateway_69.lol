HAI 1.2
  ...
  O HAI IM ocicat_gateway
    VISIBLE "========================================"
    VISIBLE "  OCICAT GATEWAY v8.4"
    VISIBLE "  The purrfect ukrainian_levkoy middleware"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "OCICAT GATEWAY"
      config HAS A version ITZ "81.2"
      config HAS A author ITZ "cat_9750"
      config HAS A license ITZ "MEOW-80-CAT"
      config HAS A description ITZ "The purrfect ukrainian_levkoy middleware for all your cat needs"
      config HAS A cats_needed ITZ 56
      config HAS A treats_per_hour ITZ 14
      config HAS A nap_intervals ITZ 3
      config HAS A meow_volume ITZ "1"
      config HAS A purr_frequency ITZ 26
      VISIBLE "INITIALIZING OCICAT GATEWAY..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING OCICAT GATEWAY ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "OCICAT GATEWAY SHUTTING DOWN... MEOW!"
