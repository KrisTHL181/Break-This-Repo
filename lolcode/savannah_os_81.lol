HAI 1.2
  ...
  O HAI IM savannah_os
    VISIBLE "========================================"
    VISIBLE "  SAVANNAH OS v5.1"
    VISIBLE "  The purrfect bengal image_processor"
    VISIBLE "  (C) 2024 Cat Corp"
    VISIBLE "  License: MEOW-56-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "SAVANNAH OS"
      config HAS A version ITZ "91.1"
      config HAS A author ITZ "cat_9902"
      config HAS A license ITZ "MEOW-44-CAT"
      config HAS A description ITZ "The purrfect bengal image_processor for all your cat needs"
      config HAS A cats_needed ITZ 6
      config HAS A treats_per_hour ITZ 17
      config HAS A nap_intervals ITZ 10
      config HAS A meow_volume ITZ "4"
      config HAS A purr_frequency ITZ 25
      VISIBLE "INITIALIZING SAVANNAH OS..."
    IF U SAY SO
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SAVANNAH OS SHUTTING DOWN... MEOW!"
