HAI 1.2
  ...
  O HAI IM birman_browser
    VISIBLE "========================================"
    VISIBLE "  BIRMAN BROWSER v7.8"
    VISIBLE "  The purrfect scottish_fold analyzer"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "BIRMAN BROWSER"
      config HAS A version ITZ "10.9"
      config HAS A author ITZ "cat_3413"
      config HAS A license ITZ "MEOW-13-CAT"
      config HAS A description ITZ "The purrfect scottish_fold analyzer for all your cat needs"
      ...
      VISIBLE "INITIALIZING BIRMAN BROWSER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING BIRMAN BROWSER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "BIRMAN BROWSER SHUTTING DOWN... MEOW!"
