HAI 1.2
  ...
  O HAI IM sphynx_physics_engine
    VISIBLE "========================================"
    VISIBLE "  SPHYNX PHYSICS_ENGINE v6.5"
    VISIBLE "  The purrfect sphynx lexer"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SPHYNX PHYSICS_ENGINE"
      config HAS A version ITZ "79.1"
      config HAS A author ITZ "cat_6379"
      config HAS A license ITZ "MEOW-88-CAT"
      config HAS A description ITZ "The purrfect sphynx lexer for all your cat needs"
      config HAS A cats_needed ITZ 48
      config HAS A treats_per_hour ITZ 97
      config HAS A nap_intervals ITZ 5
      config HAS A meow_volume ITZ "2"
      config HAS A purr_frequency ITZ 42
      VISIBLE "INITIALIZING SPHYNX PHYSICS_ENGINE..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 15
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SPHYNX PHYSICS_ENGINE ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SPHYNX PHYSICS_ENGINE SHUTTING DOWN... MEOW!"
