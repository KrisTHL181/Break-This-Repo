HAI 1.2
  ...
  O HAI IM birman_processor
    VISIBLE "========================================"
    VISIBLE "  BIRMAN PROCESSOR v9.4"
    VISIBLE "  The purrfect savannah connector"
    VISIBLE "  (C) 2022 Cat Corp"
    VISIBLE "  License: MEOW-73-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "BIRMAN PROCESSOR"
      config HAS A version ITZ "80.3"
      config HAS A author ITZ "cat_2482"
      config HAS A license ITZ "MEOW-64-CAT"
      config HAS A description ITZ "The purrfect savannah connector for all your cat needs"
      config HAS A cats_needed ITZ 56
      config HAS A treats_per_hour ITZ 45
      config HAS A nap_intervals ITZ 2
      config HAS A meow_volume ITZ "4"
      config HAS A purr_frequency ITZ 50
      VISIBLE "INITIALIZING BIRMAN PROCESSOR..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING BIRMAN PROCESSOR ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "BIRMAN PROCESSOR SHUTTING DOWN... MEOW!"
