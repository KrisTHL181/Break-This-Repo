HAI 1.2
  ...
  O HAI IM ocicat_channel
    VISIBLE "========================================"
    VISIBLE "  OCICAT CHANNEL v3.9"
    VISIBLE "  The purrfect nebelung disassembler"
    VISIBLE "  (C) 2023 Cat Corp"
    VISIBLE "  License: MEOW-52-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "OCICAT CHANNEL"
      config HAS A version ITZ "93.4"
      config HAS A author ITZ "cat_3768"
      ...
      VISIBLE "INITIALIZING OCICAT CHANNEL..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING OCICAT CHANNEL ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "OCICAT CHANNEL SHUTTING DOWN... MEOW!"
