HAI 1.2
  ...
  O HAI IM tonkinese_disassembler
    VISIBLE "========================================"
    VISIBLE "  TONKINESE DISASSEMBLER v7.6"
    VISIBLE "  The purrfect toyger stack"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "TONKINESE DISASSEMBLER"
      config HAS A version ITZ "73.1"
      config HAS A author ITZ "cat_8635"
      config HAS A license ITZ "MEOW-28-CAT"
      config HAS A description ITZ "The purrfect toyger stack for all your cat needs"
      config HAS A cats_needed ITZ 10
      config HAS A treats_per_hour ITZ 21
      config HAS A nap_intervals ITZ 7
      config HAS A meow_volume ITZ "11"
      config HAS A purr_frequency ITZ 39
      VISIBLE "INITIALIZING TONKINESE DISASSEMBLER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING TONKINESE DISASSEMBLER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "TONKINESE DISASSEMBLER SHUTTING DOWN... MEOW!"
