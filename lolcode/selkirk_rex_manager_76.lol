HAI 1.2
  ...
  O HAI IM selkirk_rex_manager
    VISIBLE "========================================"
    VISIBLE "  SELKIRK_REX MANAGER v7.8"
    VISIBLE "  The purrfect somali merger"
    VISIBLE "  (C) 2024 Cat Corp"
    VISIBLE "  License: MEOW-86-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "SELKIRK_REX MANAGER"
      config HAS A version ITZ "6.4"
      config HAS A author ITZ "cat_5321"
      config HAS A license ITZ "MEOW-32-CAT"
      config HAS A description ITZ "The purrfect somali merger for all your cat needs"
      config HAS A cats_needed ITZ 48
      config HAS A treats_per_hour ITZ 73
      config HAS A nap_intervals ITZ 20
      config HAS A meow_volume ITZ "4"
      config HAS A purr_frequency ITZ 50
      VISIBLE "INITIALIZING SELKIRK_REX MANAGER..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 16
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SELKIRK_REX MANAGER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SELKIRK_REX MANAGER SHUTTING DOWN... MEOW!"
