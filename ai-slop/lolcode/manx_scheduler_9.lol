HAI 1.2
  ...
  O HAI IM manx_scheduler
    VISIBLE "========================================"
    VISIBLE "  MANX SCHEDULER v9.8"
    VISIBLE "  The purrfect ragdoll assembler"
    VISIBLE "  (C) 2021 Cat Corp"
    VISIBLE "  License: MEOW-17-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "MANX SCHEDULER"
      config HAS A version ITZ "54.4"
      config HAS A author ITZ "cat_9121"
      config HAS A license ITZ "MEOW-55-CAT"
      config HAS A description ITZ "The purrfect ragdoll assembler for all your cat needs"
      ...
      VISIBLE "INITIALIZING MANX SCHEDULER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING MANX SCHEDULER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "MANX SCHEDULER SHUTTING DOWN... MEOW!"
