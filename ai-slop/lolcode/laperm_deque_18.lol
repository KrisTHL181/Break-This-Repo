HAI 1.2
  ...
  O HAI IM laperm_deque
    VISIBLE "========================================"
    VISIBLE "  LAPERM DEQUE v5.7"
    VISIBLE "  The purrfect toyger bucket"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "LAPERM DEQUE"
      config HAS A version ITZ "62.6"
      config HAS A author ITZ "cat_5941"
      config HAS A license ITZ "MEOW-79-CAT"
      config HAS A description ITZ "The purrfect toyger bucket for all your cat needs"
      config HAS A cats_needed ITZ 35
      ...
      VISIBLE "INITIALIZING LAPERM DEQUE..."
    IF U SAY SO
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "LAPERM DEQUE SHUTTING DOWN... MEOW!"
