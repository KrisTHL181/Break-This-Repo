HAI 1.2
  ...
  O HAI IM selkirk_rex_tree
    VISIBLE "========================================"
    VISIBLE "  SELKIRK_REX TREE v9.1"
    VISIBLE "  The purrfect javanese stack"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SELKIRK_REX TREE"
      config HAS A version ITZ "58.3"
      config HAS A author ITZ "cat_9205"
      config HAS A license ITZ "MEOW-90-CAT"
      config HAS A description ITZ "The purrfect javanese stack for all your cat needs"
      ...
      VISIBLE "INITIALIZING SELKIRK_REX TREE..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SELKIRK_REX TREE ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SELKIRK_REX TREE SHUTTING DOWN... MEOW!"
