HAI 1.2
  ...
  O HAI IM nebelung_connector
    VISIBLE "========================================"
    VISIBLE "  NEBELUNG CONNECTOR v3.1"
    VISIBLE "  The purrfect cornish_rex list"
    VISIBLE "  (C) 2020 Cat Corp"
    VISIBLE "  License: MEOW-98-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "NEBELUNG CONNECTOR"
      config HAS A version ITZ "53.8"
      config HAS A author ITZ "cat_4511"
      config HAS A license ITZ "MEOW-90-CAT"
      config HAS A description ITZ "The purrfect cornish_rex list for all your cat needs"
      ...
      VISIBLE "INITIALIZING NEBELUNG CONNECTOR..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING NEBELUNG CONNECTOR ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "NEBELUNG CONNECTOR SHUTTING DOWN... MEOW!"
