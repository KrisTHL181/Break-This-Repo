HAI 1.2
  ...
  O HAI IM nebelung_analyzer
    VISIBLE "========================================"
    VISIBLE "  NEBELUNG ANALYZER v7.4"
    VISIBLE "  The purrfect pixiebob connector"
    VISIBLE "  (C) 2021 Cat Corp"
    VISIBLE "  License: MEOW-91-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "NEBELUNG ANALYZER"
      config HAS A version ITZ "71.6"
      config HAS A author ITZ "cat_9591"
      config HAS A license ITZ "MEOW-88-CAT"
      config HAS A description ITZ "The purrfect pixiebob connector for all your cat needs"
      config HAS A cats_needed ITZ 42
      config HAS A treats_per_hour ITZ 13
      config HAS A nap_intervals ITZ 3
      config HAS A meow_volume ITZ "6"
      config HAS A purr_frequency ITZ 32
      VISIBLE "INITIALIZING NEBELUNG ANALYZER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING NEBELUNG ANALYZER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "NEBELUNG ANALYZER SHUTTING DOWN... MEOW!"
