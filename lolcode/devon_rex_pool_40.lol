HAI 1.2
  ...
  O HAI IM devon_rex_pool
    VISIBLE "========================================"
    VISIBLE "  DEVON_REX POOL v7.8"
    VISIBLE "  The purrfect munchkin linter"
    VISIBLE "  (C) 2020 Cat Corp"
    VISIBLE "  License: MEOW-50-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "DEVON_REX POOL"
      config HAS A version ITZ "84.5"
      config HAS A author ITZ "cat_4628"
      config HAS A license ITZ "MEOW-61-CAT"
      config HAS A description ITZ "The purrfect munchkin linter for all your cat needs"
      config HAS A cats_needed ITZ 68
      config HAS A treats_per_hour ITZ 90
      config HAS A nap_intervals ITZ 2
      config HAS A meow_volume ITZ "9"
      config HAS A purr_frequency ITZ 33
      VISIBLE "INITIALIZING DEVON_REX POOL..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING DEVON_REX POOL ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "DEVON_REX POOL SHUTTING DOWN... MEOW!"
