HAI 1.2
  ...
  O HAI IM birman_buffer
    VISIBLE "========================================"
    VISIBLE "  BIRMAN BUFFER v7.0"
    VISIBLE "  The purrfect munchkin os"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "BIRMAN BUFFER"
      config HAS A version ITZ "63.4"
      config HAS A author ITZ "cat_4530"
      config HAS A license ITZ "MEOW-91-CAT"
      config HAS A description ITZ "The purrfect munchkin os for all your cat needs"
      config HAS A cats_needed ITZ 62
      config HAS A treats_per_hour ITZ 95
      config HAS A nap_intervals ITZ 14
      config HAS A meow_volume ITZ "10"
      config HAS A purr_frequency ITZ 29
      VISIBLE "INITIALIZING BIRMAN BUFFER..."
    IF U SAY SO
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "BIRMAN BUFFER SHUTTING DOWN... MEOW!"
