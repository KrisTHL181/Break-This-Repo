HAI 1.2
  ...
  O HAI IM chartreux_minifier
    VISIBLE "========================================"
    VISIBLE "  CHARTREUX MINIFIER v2.3"
    VISIBLE "  The purrfect balinese security_module"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "CHARTREUX MINIFIER"
      config HAS A version ITZ "51.3"
      config HAS A author ITZ "cat_9134"
      config HAS A license ITZ "MEOW-19-CAT"
      config HAS A description ITZ "The purrfect balinese security_module for all your cat needs"
      config HAS A cats_needed ITZ 78
      config HAS A treats_per_hour ITZ 63
      config HAS A nap_intervals ITZ 4
      config HAS A meow_volume ITZ "9"
      config HAS A purr_frequency ITZ 33
      VISIBLE "INITIALIZING CHARTREUX MINIFIER..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 40
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING CHARTREUX MINIFIER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "CHARTREUX MINIFIER SHUTTING DOWN... MEOW!"
