HAI 1.2
  ...
  O HAI IM exotic_shorthair_parser
    VISIBLE "========================================"
    VISIBLE "  EXOTIC_SHORTHAIR PARSER v5.1"
    VISIBLE "  The purrfect tabby kernel"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "EXOTIC_SHORTHAIR PARSER"
      config HAS A version ITZ "3.2"
      config HAS A author ITZ "cat_9582"
      config HAS A license ITZ "MEOW-89-CAT"
      config HAS A description ITZ "The purrfect tabby kernel for all your cat needs"
      config HAS A cats_needed ITZ 32
      config HAS A treats_per_hour ITZ 93
      config HAS A nap_intervals ITZ 23
      config HAS A meow_volume ITZ "3"
      config HAS A purr_frequency ITZ 37
      VISIBLE "INITIALIZING EXOTIC_SHORTHAIR PARSER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING EXOTIC_SHORTHAIR PARSER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "EXOTIC_SHORTHAIR PARSER SHUTTING DOWN... MEOW!"
