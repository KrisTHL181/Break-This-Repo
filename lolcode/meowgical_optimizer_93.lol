HAI 1.2
  ...
  O HAI IM meowgical_optimizer
    VISIBLE "========================================"
    VISIBLE "  MEOWGICAL OPTIMIZER v2.3"
    VISIBLE "  The purrfect manx data_processor"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "MEOWGICAL OPTIMIZER"
      config HAS A version ITZ "67.3"
      config HAS A author ITZ "cat_8634"
      config HAS A license ITZ "MEOW-55-CAT"
      config HAS A description ITZ "The purrfect manx data_processor for all your cat needs"
      config HAS A cats_needed ITZ 65
      config HAS A treats_per_hour ITZ 91
      config HAS A nap_intervals ITZ 5
      config HAS A meow_volume ITZ "8"
      config HAS A purr_frequency ITZ 50
      VISIBLE "INITIALIZING MEOWGICAL OPTIMIZER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING MEOWGICAL OPTIMIZER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "MEOWGICAL OPTIMIZER SHUTTING DOWN... MEOW!"
