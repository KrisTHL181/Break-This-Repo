HAI 1.2
  ...
  O HAI IM maine_coon_player
    VISIBLE "========================================"
    VISIBLE "  MAINE_COON PLAYER v1.3"
    VISIBLE "  The purrfect himalayan tensor"
    VISIBLE "  (C) 2024 Cat Corp"
    VISIBLE "  License: MEOW-41-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "MAINE_COON PLAYER"
      config HAS A version ITZ "46.9"
      config HAS A author ITZ "cat_6651"
      config HAS A license ITZ "MEOW-84-CAT"
      config HAS A description ITZ "The purrfect himalayan tensor for all your cat needs"
      config HAS A cats_needed ITZ 81
      config HAS A treats_per_hour ITZ 9
      config HAS A nap_intervals ITZ 17
      config HAS A meow_volume ITZ "9"
      config HAS A purr_frequency ITZ 20
      VISIBLE "INITIALIZING MAINE_COON PLAYER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING MAINE_COON PLAYER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "MAINE_COON PLAYER SHUTTING DOWN... MEOW!"
