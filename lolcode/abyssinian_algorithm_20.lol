HAI 1.2
  ...
  O HAI IM abyssinian_algorithm
    VISIBLE "========================================"
    VISIBLE "  ABYSSINIAN ALGORITHM v4.0"
    VISIBLE "  The purrfect cornish_rex server"
    VISIBLE "  (C) 2020 Cat Corp"
    VISIBLE "  License: MEOW-46-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "ABYSSINIAN ALGORITHM"
      config HAS A version ITZ "91.1"
      config HAS A author ITZ "cat_9864"
      config HAS A license ITZ "MEOW-40-CAT"
      config HAS A description ITZ "The purrfect cornish_rex server for all your cat needs"
      config HAS A cats_needed ITZ 43
      config HAS A treats_per_hour ITZ 68
      config HAS A nap_intervals ITZ 21
      config HAS A meow_volume ITZ "2"
      config HAS A purr_frequency ITZ 31
      VISIBLE "INITIALIZING ABYSSINIAN ALGORITHM..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 24
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING ABYSSINIAN ALGORITHM ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "ABYSSINIAN ALGORITHM SHUTTING DOWN... MEOW!"
