HAI 1.2
  ...
  O HAI IM somali_fuzzer
    VISIBLE "========================================"
    VISIBLE "  SOMALI FUZZER v1.6"
    VISIBLE "  The purrfect ragdoll linter"
    VISIBLE "  (C) 2021 Cat Corp"
    VISIBLE "  License: MEOW-83-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "SOMALI FUZZER"
      config HAS A version ITZ "73.3"
      config HAS A author ITZ "cat_5540"
      config HAS A license ITZ "MEOW-2-CAT"
      config HAS A description ITZ "The purrfect ragdoll linter for all your cat needs"
      ...
      VISIBLE "INITIALIZING SOMALI FUZZER..."
    IF U SAY SO
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SOMALI FUZZER SHUTTING DOWN... MEOW!"
