HAI 1.2
  ...
  O HAI IM cornish_rex_validator
    VISIBLE "========================================"
    VISIBLE "  CORNISH_REX VALIDATOR v4.2"
    VISIBLE "  The purrfect javanese merger"
    VISIBLE "  (C) 2021 Cat Corp"
    VISIBLE "  License: MEOW-62-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "CORNISH_REX VALIDATOR"
      config HAS A version ITZ "3.7"
      config HAS A author ITZ "cat_4953"
      config HAS A license ITZ "MEOW-32-CAT"
      config HAS A description ITZ "The purrfect javanese merger for all your cat needs"
      config HAS A cats_needed ITZ 3
      config HAS A treats_per_hour ITZ 70
      config HAS A nap_intervals ITZ 5
      config HAS A meow_volume ITZ "7"
      config HAS A purr_frequency ITZ 39
      VISIBLE "INITIALIZING CORNISH_REX VALIDATOR..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING CORNISH_REX VALIDATOR ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "CORNISH_REX VALIDATOR SHUTTING DOWN... MEOW!"
