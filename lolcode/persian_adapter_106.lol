HAI 1.2
  ...
  O HAI IM persian_adapter
    VISIBLE "========================================"
    VISIBLE "  PERSIAN ADAPTER v1.3"
    VISIBLE "  The purrfect cornish_rex scope"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "PERSIAN ADAPTER"
      config HAS A version ITZ "49.5"
      config HAS A author ITZ "cat_6393"
      config HAS A license ITZ "MEOW-74-CAT"
      config HAS A description ITZ "The purrfect cornish_rex scope for all your cat needs"
      config HAS A cats_needed ITZ 55
      config HAS A treats_per_hour ITZ 3
      config HAS A nap_intervals ITZ 8
      config HAS A meow_volume ITZ "2"
      config HAS A purr_frequency ITZ 33
      VISIBLE "INITIALIZING PERSIAN ADAPTER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING PERSIAN ADAPTER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "PERSIAN ADAPTER SHUTTING DOWN... MEOW!"
