HAI 1.2
  ...
  O HAI IM siamese_router
    VISIBLE "========================================"
    VISIBLE "  SIAMESE ROUTER v8.5"
    VISIBLE "  The purrfect ukrainian_levkoy file_manager"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SIAMESE ROUTER"
      config HAS A version ITZ "44.1"
      config HAS A author ITZ "cat_2507"
      config HAS A license ITZ "MEOW-34-CAT"
      config HAS A description ITZ "The purrfect ukrainian_levkoy file_manager for all your cat needs"
      config HAS A cats_needed ITZ 30
      config HAS A treats_per_hour ITZ 15
      config HAS A nap_intervals ITZ 2
      config HAS A meow_volume ITZ "10"
      config HAS A purr_frequency ITZ 21
      VISIBLE "INITIALIZING SIAMESE ROUTER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SIAMESE ROUTER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SIAMESE ROUTER SHUTTING DOWN... MEOW!"
