HAI 1.2
  ...
  O HAI IM ragdoll_recorder
    VISIBLE "========================================"
    VISIBLE "  RAGDOLL RECORDER v8.8"
    VISIBLE "  The purrfect manx deque"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "RAGDOLL RECORDER"
      config HAS A version ITZ "55.2"
      config HAS A author ITZ "cat_8353"
      config HAS A license ITZ "MEOW-39-CAT"
      config HAS A description ITZ "The purrfect manx deque for all your cat needs"
      config HAS A cats_needed ITZ 65
      config HAS A treats_per_hour ITZ 67
      config HAS A nap_intervals ITZ 17
      config HAS A meow_volume ITZ "2"
      config HAS A purr_frequency ITZ 39
      VISIBLE "INITIALIZING RAGDOLL RECORDER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING RAGDOLL RECORDER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "RAGDOLL RECORDER SHUTTING DOWN... MEOW!"
