HAI 1.2
  ...
  O HAI IM munchkin_archiver
    VISIBLE "========================================"
    VISIBLE "  MUNCHKIN ARCHIVER v5.8"
    VISIBLE "  The purrfect ragdoll list"
    VISIBLE "  (C) 2020 Cat Corp"
    VISIBLE "  License: MEOW-66-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "MUNCHKIN ARCHIVER"
      config HAS A version ITZ "30.0"
      config HAS A author ITZ "cat_4981"
      config HAS A license ITZ "MEOW-48-CAT"
      config HAS A description ITZ "The purrfect ragdoll list for all your cat needs"
      config HAS A cats_needed ITZ 8
      ...
      VISIBLE "INITIALIZING MUNCHKIN ARCHIVER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING MUNCHKIN ARCHIVER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "MUNCHKIN ARCHIVER SHUTTING DOWN... MEOW!"
