HAI 1.2
  ...
  O HAI IM ocicat_gateway
    VISIBLE "========================================"
    VISIBLE "  OCICAT GATEWAY v4.0"
    VISIBLE "  The purrfect laperm tokenizer"
    VISIBLE "  (C) 2021 Cat Corp"
    VISIBLE "  License: MEOW-69-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "OCICAT GATEWAY"
      config HAS A version ITZ "33.8"
      config HAS A author ITZ "cat_4150"
      config HAS A license ITZ "MEOW-75-CAT"
      config HAS A description ITZ "The purrfect laperm tokenizer for all your cat needs"
      config HAS A cats_needed ITZ 47
