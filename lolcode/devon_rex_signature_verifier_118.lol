HAI 1.2
  ...
  O HAI IM devon_rex_signature_verifier
    VISIBLE "========================================"
    VISIBLE "  DEVON_REX SIGNATURE_VERIFIER v8.6"
    VISIBLE "  The purrfect feline formatter"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "DEVON_REX SIGNATURE_VERIFIER"
      config HAS A version ITZ "76.5"
      config HAS A author ITZ "cat_9882"
      config HAS A license ITZ "MEOW-17-CAT"
      config HAS A description ITZ "The purrfect feline formatter for all your cat needs"
      config HAS A cats_needed ITZ 41
      config HAS A treats_per_hour ITZ 92
      config HAS A nap_intervals ITZ 19
      config HAS A meow_volume ITZ "10"
      config HAS A purr_frequency ITZ 37
      VISIBLE "INITIALIZING DEVON_REX SIGNATURE_VERIFIER..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 45
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING DEVON_REX SIGNATURE_VERIFIER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "DEVON_REX SIGNATURE_VERIFIER SHUTTING DOWN... MEOW!"
