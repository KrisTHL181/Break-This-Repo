HAI 1.2
  ...
  O HAI IM exotic_shorthair_framework
    VISIBLE "========================================"
    VISIBLE "  EXOTIC_SHORTHAIR FRAMEWORK v3.1"
    VISIBLE "  The purrfect nebelung framework"
    VISIBLE "  (C) 2020 Cat Corp"
    VISIBLE "  License: MEOW-5-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "EXOTIC_SHORTHAIR FRAMEWORK"
      config HAS A version ITZ "70.6"
      config HAS A author ITZ "cat_6038"
      config HAS A license ITZ "MEOW-46-CAT"
      config HAS A description ITZ "The purrfect nebelung framework for all your cat needs"
      config HAS A cats_needed ITZ 46
      config HAS A treats_per_hour ITZ 35
      config HAS A nap_intervals ITZ 18
      config HAS A meow_volume ITZ "8"
      config HAS A purr_frequency ITZ 23
      VISIBLE "INITIALIZING EXOTIC_SHORTHAIR FRAMEWORK..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 14
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING EXOTIC_SHORTHAIR FRAMEWORK ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "EXOTIC_SHORTHAIR FRAMEWORK SHUTTING DOWN... MEOW!"
