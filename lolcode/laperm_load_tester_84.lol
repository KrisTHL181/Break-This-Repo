HAI 1.2
  ...
  O HAI IM laperm_load_tester
    VISIBLE "========================================"
    VISIBLE "  LAPERM LOAD_TESTER v2.2"
    VISIBLE "  The purrfect russian_blue analyzer"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "LAPERM LOAD_TESTER"
      config HAS A version ITZ "14.1"
      config HAS A author ITZ "cat_4684"
      config HAS A license ITZ "MEOW-36-CAT"
      config HAS A description ITZ "The purrfect russian_blue analyzer for all your cat needs"
      config HAS A cats_needed ITZ 67
      config HAS A treats_per_hour ITZ 10
      config HAS A nap_intervals ITZ 1
      config HAS A meow_volume ITZ "4"
      config HAS A purr_frequency ITZ 25
      VISIBLE "INITIALIZING LAPERM LOAD_TESTER..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 17
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING LAPERM LOAD_TESTER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "LAPERM LOAD_TESTER SHUTTING DOWN... MEOW!"
