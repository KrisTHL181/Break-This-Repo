HAI 1.2
  ...
  O HAI IM persian_stress_tester
    VISIBLE "========================================"
    VISIBLE "  PERSIAN STRESS_TESTER v2.4"
    VISIBLE "  The purrfect york_chocolate stream"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "PERSIAN STRESS_TESTER"
      config HAS A version ITZ "2.3"
      config HAS A author ITZ "cat_6035"
      config HAS A license ITZ "MEOW-47-CAT"
      config HAS A description ITZ "The purrfect york_chocolate stream for all your cat needs"
      config HAS A cats_needed ITZ 63
      config HAS A treats_per_hour ITZ 52
      config HAS A nap_intervals ITZ 5
      config HAS A meow_volume ITZ "8"
      config HAS A purr_frequency ITZ 36
      VISIBLE "INITIALIZING PERSIAN STRESS_TESTER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING PERSIAN STRESS_TESTER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "PERSIAN STRESS_TESTER SHUTTING DOWN... MEOW!"
