HAI 1.2
  ...
  O HAI IM ragdoll_hash_function
    VISIBLE "========================================"
    VISIBLE "  RAGDOLL HASH_FUNCTION v7.9"
    VISIBLE "  The purrfect balinese service"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "RAGDOLL HASH_FUNCTION"
      config HAS A version ITZ "40.3"
      config HAS A author ITZ "cat_5464"
      config HAS A license ITZ "MEOW-14-CAT"
      config HAS A description ITZ "The purrfect balinese service for all your cat needs"
      ...
      VISIBLE "INITIALIZING RAGDOLL HASH_FUNCTION..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING RAGDOLL HASH_FUNCTION ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "RAGDOLL HASH_FUNCTION SHUTTING DOWN... MEOW!"
