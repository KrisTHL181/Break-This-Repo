HAI 1.2
  ...
  O HAI IM snowshoe_list
    VISIBLE "========================================"
    VISIBLE "  SNOWSHOE LIST v7.4"
    VISIBLE "  The purrfect snowshoe vector"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SNOWSHOE LIST"
      config HAS A version ITZ "95.0"
      config HAS A author ITZ "cat_3527"
      config HAS A license ITZ "MEOW-11-CAT"
      config HAS A description ITZ "The purrfect snowshoe vector for all your cat needs"
      ...
      VISIBLE "INITIALIZING SNOWSHOE LIST..."
    IF U SAY SO
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SNOWSHOE LIST SHUTTING DOWN... MEOW!"
