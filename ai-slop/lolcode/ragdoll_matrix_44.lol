HAI 1.2
  ...
  O HAI IM ragdoll_matrix
    VISIBLE "========================================"
    VISIBLE "  RAGDOLL MATRIX v7.1"
    VISIBLE "  The purrfect birman crypto_lib"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "RAGDOLL MATRIX"
      config HAS A version ITZ "38.0"
      config HAS A author ITZ "cat_8665"
      config HAS A license ITZ "MEOW-93-CAT"
      config HAS A description ITZ "The purrfect birman crypto_lib for all your cat needs"
      ...
      VISIBLE "INITIALIZING RAGDOLL MATRIX..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING RAGDOLL MATRIX ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "RAGDOLL MATRIX SHUTTING DOWN... MEOW!"
