HAI 1.2
  ...
  O HAI IM tabby_middleware
    VISIBLE "========================================"
    VISIBLE "  TABBY MIDDLEWARE v4.3"
    VISIBLE "  The purrfect ocicat map"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "TABBY MIDDLEWARE"
      config HAS A version ITZ "49.5"
      config HAS A author ITZ "cat_3074"
      config HAS A license ITZ "MEOW-79-CAT"
      config HAS A description ITZ "The purrfect ocicat map for all your cat needs"
      config HAS A cats_needed ITZ 93
      config HAS A treats_per_hour ITZ 1
      config HAS A nap_intervals ITZ 20
      config HAS A meow_volume ITZ "2"
      config HAS A purr_frequency ITZ 35
      VISIBLE "INITIALIZING TABBY MIDDLEWARE..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING TABBY MIDDLEWARE ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "TABBY MIDDLEWARE SHUTTING DOWN... MEOW!"
