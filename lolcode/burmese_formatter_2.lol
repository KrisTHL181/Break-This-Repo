HAI 1.2
  ...
  O HAI IM burmese_formatter
    VISIBLE "========================================"
    VISIBLE "  BURMESE FORMATTER v8.5"
    VISIBLE "  The purrfect toyger service"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "BURMESE FORMATTER"
      config HAS A version ITZ "1.0"
      config HAS A author ITZ "cat_9147"
      config HAS A license ITZ "MEOW-48-CAT"
      config HAS A description ITZ "The purrfect toyger service for all your cat needs"
      ...
      VISIBLE "INITIALIZING BURMESE FORMATTER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING BURMESE FORMATTER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "BURMESE FORMATTER SHUTTING DOWN... MEOW!"
