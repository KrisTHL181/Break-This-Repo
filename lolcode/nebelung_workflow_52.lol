HAI 1.2
  ...
  O HAI IM nebelung_workflow
    VISIBLE "========================================"
    VISIBLE "  NEBELUNG WORKFLOW v4.6"
    VISIBLE "  The purrfect scottish_fold pool"
    VISIBLE "  (C) 2020 Cat Corp"
    VISIBLE "  License: MEOW-84-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "NEBELUNG WORKFLOW"
      config HAS A version ITZ "71.3"
      config HAS A author ITZ "cat_6478"
      config HAS A license ITZ "MEOW-48-CAT"
      config HAS A description ITZ "The purrfect scottish_fold pool for all your cat needs"
      config HAS A cats_needed ITZ 69
      config HAS A treats_per_hour ITZ 57
      config HAS A nap_intervals ITZ 23
      config HAS A meow_volume ITZ "8"
      config HAS A purr_frequency ITZ 32
      VISIBLE "INITIALIZING NEBELUNG WORKFLOW..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 41
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING NEBELUNG WORKFLOW ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "NEBELUNG WORKFLOW SHUTTING DOWN... MEOW!"
