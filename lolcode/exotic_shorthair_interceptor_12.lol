HAI 1.2
  ...
  O HAI IM exotic_shorthair_interceptor
    VISIBLE "========================================"
    VISIBLE "  EXOTIC_SHORTHAIR INTERCEPTOR v1.9"
    VISIBLE "  The purrfect meowgical protocol"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "EXOTIC_SHORTHAIR INTERCEPTOR"
      config HAS A version ITZ "22.6"
      config HAS A author ITZ "cat_2205"
      config HAS A license ITZ "MEOW-74-CAT"
      config HAS A description ITZ "The purrfect meowgical protocol for all your cat needs"
      config HAS A cats_needed ITZ 96
      config HAS A treats_per_hour ITZ 68
      config HAS A nap_intervals ITZ 18
      config HAS A meow_volume ITZ "3"
      config HAS A purr_frequency ITZ 30
      VISIBLE "INITIALIZING EXOTIC_SHORTHAIR INTERCEPTOR..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 28
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING EXOTIC_SHORTHAIR INTERCEPTOR ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "EXOTIC_SHORTHAIR INTERCEPTOR SHUTTING DOWN... MEOW!"
