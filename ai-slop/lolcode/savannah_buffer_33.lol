HAI 1.2
  ...
  O HAI IM savannah_buffer
    VISIBLE "========================================"
    VISIBLE "  SAVANNAH BUFFER v9.1"
    VISIBLE "  The purrfect nebelung decryptor"
    VISIBLE "  (C) 2022 Cat Corp"
    VISIBLE "  License: MEOW-65-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "SAVANNAH BUFFER"
      config HAS A version ITZ "47.3"
      config HAS A author ITZ "cat_1619"
      config HAS A license ITZ "MEOW-54-CAT"
      config HAS A description ITZ "The purrfect nebelung decryptor for all your cat needs"
      config HAS A cats_needed ITZ 88
      config HAS A treats_per_hour ITZ 31
      config HAS A nap_intervals ITZ 4
      config HAS A meow_volume ITZ "11"
      config HAS A purr_frequency ITZ 46
      VISIBLE "INITIALIZING SAVANNAH BUFFER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SAVANNAH BUFFER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SAVANNAH BUFFER SHUTTING DOWN... MEOW!"
