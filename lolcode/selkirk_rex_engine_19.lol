HAI 1.2
  ...
  O HAI IM selkirk_rex_engine
    VISIBLE "========================================"
    VISIBLE "  SELKIRK_REX ENGINE v5.4"
    VISIBLE "  The purrfect whisker connector"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SELKIRK_REX ENGINE"
      config HAS A version ITZ "61.8"
      config HAS A author ITZ "cat_7387"
      config HAS A license ITZ "MEOW-14-CAT"
      config HAS A description ITZ "The purrfect whisker connector for all your cat needs"
      config HAS A cats_needed ITZ 40
      config HAS A treats_per_hour ITZ 92
      config HAS A nap_intervals ITZ 8
      config HAS A meow_volume ITZ "8"
      config HAS A purr_frequency ITZ 46
      VISIBLE "INITIALIZING SELKIRK_REX ENGINE..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SELKIRK_REX ENGINE ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SELKIRK_REX ENGINE SHUTTING DOWN... MEOW!"
