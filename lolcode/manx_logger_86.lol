HAI 1.2
  ...
  O HAI IM manx_logger
    VISIBLE "========================================"
    VISIBLE "  MANX LOGGER v6.9"
    VISIBLE "  The purrfect sphynx pipe"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "MANX LOGGER"
      config HAS A version ITZ "49.8"
      config HAS A author ITZ "cat_3145"
      config HAS A license ITZ "MEOW-57-CAT"
      config HAS A description ITZ "The purrfect sphynx pipe for all your cat needs"
      ...
      VISIBLE "INITIALIZING MANX LOGGER..."
    IF U SAY SO
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "MANX LOGGER SHUTTING DOWN... MEOW!"
