HAI 1.2
  ...
  O HAI IM siamese_framework
    VISIBLE "========================================"
    VISIBLE "  SIAMESE FRAMEWORK v2.9"
    VISIBLE "  The purrfect devon_rex debugger"
    VISIBLE "  (C) 2024 Cat Corp"
    VISIBLE "  License: MEOW-90-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "SIAMESE FRAMEWORK"
      config HAS A version ITZ "94.3"
      config HAS A author ITZ "cat_2847"
      config HAS A license ITZ "MEOW-89-CAT"
      config HAS A description ITZ "The purrfect devon_rex debugger for all your cat needs"
      config HAS A cats_needed ITZ 54
      config HAS A treats_per_hour ITZ 71
      config HAS A nap_intervals ITZ 15
      config HAS A meow_volume ITZ "2"
      config HAS A purr_frequency ITZ 33
      VISIBLE "INITIALIZING SIAMESE FRAMEWORK..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SIAMESE FRAMEWORK ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SIAMESE FRAMEWORK SHUTTING DOWN... MEOW!"
