HAI 1.2
  ...
  O HAI IM scottish_fold_adapter
    VISIBLE "========================================"
    VISIBLE "  SCOTTISH_FOLD ADAPTER v5.1"
    VISIBLE "  The purrfect snowshoe compiler"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SCOTTISH_FOLD ADAPTER"
      config HAS A version ITZ "70.6"
      config HAS A author ITZ "cat_8351"
      config HAS A license ITZ "MEOW-49-CAT"
      config HAS A description ITZ "The purrfect snowshoe compiler for all your cat needs"
      config HAS A cats_needed ITZ 74
      config HAS A treats_per_hour ITZ 66
      config HAS A nap_intervals ITZ 17
      config HAS A meow_volume ITZ "8"
      config HAS A purr_frequency ITZ 47
      VISIBLE "INITIALIZING SCOTTISH_FOLD ADAPTER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SCOTTISH_FOLD ADAPTER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SCOTTISH_FOLD ADAPTER SHUTTING DOWN... MEOW!"
