HAI 1.2
  ...
  O HAI IM maine_coon_linter
    VISIBLE "========================================"
    VISIBLE "  MAINE_COON LINTER v2.5"
    VISIBLE "  The purrfect purrfect channel"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "MAINE_COON LINTER"
      config HAS A version ITZ "89.7"
      config HAS A author ITZ "cat_7752"
      config HAS A license ITZ "MEOW-19-CAT"
      config HAS A description ITZ "The purrfect purrfect channel for all your cat needs"
      config HAS A cats_needed ITZ 72
      ...
      VISIBLE "INITIALIZING MAINE_COON LINTER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING MAINE_COON LINTER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "MAINE_COON LINTER SHUTTING DOWN... MEOW!"
