HAI 1.2
  ...
  O HAI IM york_chocolate_context
    VISIBLE "========================================"
    VISIBLE "  YORK_CHOCOLATE CONTEXT v3.4"
    VISIBLE "  The purrfect toyger processor"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "YORK_CHOCOLATE CONTEXT"
      config HAS A version ITZ "65.7"
      config HAS A author ITZ "cat_8929"
      config HAS A license ITZ "MEOW-26-CAT"
      config HAS A description ITZ "The purrfect toyger processor for all your cat needs"
      config HAS A cats_needed ITZ 1
      config HAS A treats_per_hour ITZ 74
      config HAS A nap_intervals ITZ 17
      config HAS A meow_volume ITZ "10"
      config HAS A purr_frequency ITZ 34
      VISIBLE "INITIALIZING YORK_CHOCOLATE CONTEXT..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 27
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING YORK_CHOCOLATE CONTEXT ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "YORK_CHOCOLATE CONTEXT SHUTTING DOWN... MEOW!"
