HAI 1.2
  ...
  O HAI IM york_chocolate_graphics_engine
    VISIBLE "========================================"
    VISIBLE "  YORK_CHOCOLATE GRAPHICS_ENGINE v8.4"
    VISIBLE "  The purrfect exotic_shorthair chaos_tester"
    VISIBLE "  (C) 2022 Cat Corp"
    VISIBLE "  License: MEOW-55-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "YORK_CHOCOLATE GRAPHICS_ENGINE"
      config HAS A version ITZ "87.6"
      config HAS A author ITZ "cat_5049"
      config HAS A license ITZ "MEOW-17-CAT"
      config HAS A description ITZ "The purrfect exotic_shorthair chaos_tester for all your cat needs"
      config HAS A cats_needed ITZ 33
      config HAS A treats_per_hour ITZ 80
      config HAS A nap_intervals ITZ 16
      config HAS A meow_volume ITZ "10"
      config HAS A purr_frequency ITZ 38
      VISIBLE "INITIALIZING YORK_CHOCOLATE GRAPHICS_ENGINE..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 22
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING YORK_CHOCOLATE GRAPHICS_ENGINE ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "YORK_CHOCOLATE GRAPHICS_ENGINE SHUTTING DOWN... MEOW!"
