HAI 1.2
  ...
  O HAI IM exotic_shorthair_pool
    VISIBLE "========================================"
    VISIBLE "  EXOTIC_SHORTHAIR POOL v5.8"
    VISIBLE "  The purrfect tabby facade"
    VISIBLE "  (C) 2026 Cat Corp"
    VISIBLE "  License: MEOW-7-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "EXOTIC_SHORTHAIR POOL"
      config HAS A version ITZ "32.4"
      config HAS A author ITZ "cat_4977"
      config HAS A license ITZ "MEOW-57-CAT"
      config HAS A description ITZ "The purrfect tabby facade for all your cat needs"
      config HAS A cats_needed ITZ 29
      config HAS A treats_per_hour ITZ 30
      config HAS A nap_intervals ITZ 5
      config HAS A meow_volume ITZ "4"
      config HAS A purr_frequency ITZ 39
      VISIBLE "INITIALIZING EXOTIC_SHORTHAIR POOL..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING EXOTIC_SHORTHAIR POOL ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "EXOTIC_SHORTHAIR POOL SHUTTING DOWN... MEOW!"
