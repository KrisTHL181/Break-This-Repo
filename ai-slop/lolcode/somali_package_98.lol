HAI 1.2
  ...
  O HAI IM somali_package
    VISIBLE "========================================"
    VISIBLE "  SOMALI PACKAGE v1.6"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SOMALI PACKAGE"
      config HAS A version ITZ "99.5"
      config HAS A author ITZ "cat_2715"
      config HAS A license ITZ "MEOW-95-CAT"
      ...
      VISIBLE "INITIALIZING SOMALI PACKAGE..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SOMALI PACKAGE ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SOMALI PACKAGE SHUTTING DOWN... MEOW!"
