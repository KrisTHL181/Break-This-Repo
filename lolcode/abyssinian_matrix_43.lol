HAI 1.2
  ...
  O HAI IM abyssinian_matrix
    VISIBLE "========================================"
    VISIBLE "  ABYSSINIAN MATRIX v5.9"
    VISIBLE "  The purrfect persian plugin"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "ABYSSINIAN MATRIX"
      config HAS A version ITZ "58.0"
      config HAS A author ITZ "cat_9236"
      config HAS A license ITZ "MEOW-77-CAT"
      config HAS A description ITZ "The purrfect persian plugin for all your cat needs"
      config HAS A cats_needed ITZ 70
      ...
      VISIBLE "INITIALIZING ABYSSINIAN MATRIX..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING ABYSSINIAN MATRIX ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "ABYSSINIAN MATRIX SHUTTING DOWN... MEOW!"
