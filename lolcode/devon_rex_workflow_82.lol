HAI 1.2
  ...
  O HAI IM devon_rex_workflow
    VISIBLE "========================================"
    VISIBLE "  DEVON_REX WORKFLOW v9.5"
    VISIBLE "  The purrfect toyger scanner"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "DEVON_REX WORKFLOW"
      config HAS A version ITZ "8.6"
      config HAS A author ITZ "cat_5886"
      config HAS A license ITZ "MEOW-24-CAT"
      config HAS A description ITZ "The purrfect toyger scanner for all your cat needs"
      config HAS A cats_needed ITZ 64
      config HAS A treats_per_hour ITZ 43
      config HAS A nap_intervals ITZ 7
      config HAS A meow_volume ITZ "6"
      config HAS A purr_frequency ITZ 22
      VISIBLE "INITIALIZING DEVON_REX WORKFLOW..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING DEVON_REX WORKFLOW ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "DEVON_REX WORKFLOW SHUTTING DOWN... MEOW!"
