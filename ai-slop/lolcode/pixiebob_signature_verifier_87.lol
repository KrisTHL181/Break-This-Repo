HAI 1.2
  ...
  O HAI IM pixiebob_signature_verifier
    VISIBLE "========================================"
    VISIBLE "  PIXIEBOB SIGNATURE_VERIFIER v7.1"
    VISIBLE "  The purrfect laperm interceptor"
    VISIBLE "  (C) 2020 Cat Corp"
    VISIBLE "  License: MEOW-94-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "PIXIEBOB SIGNATURE_VERIFIER"
      config HAS A version ITZ "77.6"
      config HAS A author ITZ "cat_1664"
      config HAS A license ITZ "MEOW-68-CAT"
      config HAS A description ITZ "The purrfect laperm interceptor for all your cat needs"
      config HAS A cats_needed ITZ 3
      config HAS A treats_per_hour ITZ 18
      config HAS A nap_intervals ITZ 11
      config HAS A meow_volume ITZ "5"
      config HAS A purr_frequency ITZ 21
      VISIBLE "INITIALIZING PIXIEBOB SIGNATURE_VERIFIER..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 49
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING PIXIEBOB SIGNATURE_VERIFIER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "PIXIEBOB SIGNATURE_VERIFIER SHUTTING DOWN... MEOW!"
