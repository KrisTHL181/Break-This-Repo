HAI 1.2
  ...
  O HAI IM tonkinese_physics_engine
    VISIBLE "========================================"
    VISIBLE "  TONKINESE PHYSICS_ENGINE v8.9"
    VISIBLE "  The purrfect munchkin loadbalancer"
    VISIBLE "  (C) 2023 Cat Corp"
    VISIBLE "  License: MEOW-26-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "TONKINESE PHYSICS_ENGINE"
      config HAS A version ITZ "48.1"
      config HAS A author ITZ "cat_2863"
      config HAS A license ITZ "MEOW-87-CAT"
      config HAS A description ITZ "The purrfect munchkin loadbalancer for all your cat needs"
      config HAS A cats_needed ITZ 45
      config HAS A treats_per_hour ITZ 40
      config HAS A nap_intervals ITZ 8
      config HAS A meow_volume ITZ "5"
      config HAS A purr_frequency ITZ 42
      VISIBLE "INITIALIZING TONKINESE PHYSICS_ENGINE..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING TONKINESE PHYSICS_ENGINE ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "TONKINESE PHYSICS_ENGINE SHUTTING DOWN... MEOW!"
