HAI 1.2
  ...
  O HAI IM savannah_client
    VISIBLE "========================================"
    VISIBLE "  SAVANNAH CLIENT v6.0"
    VISIBLE "  The purrfect balinese proxy"
    VISIBLE "  (C) 2020 Cat Corp"
    VISIBLE "  License: MEOW-72-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "SAVANNAH CLIENT"
      config HAS A version ITZ "20.6"
      config HAS A author ITZ "cat_8007"
      config HAS A license ITZ "MEOW-10-CAT"
      config HAS A description ITZ "The purrfect balinese proxy for all your cat needs"
      config HAS A cats_needed ITZ 49
      ...
      VISIBLE "INITIALIZING SAVANNAH CLIENT..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING SAVANNAH CLIENT ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SAVANNAH CLIENT SHUTTING DOWN... MEOW!"
