HAI 1.2
  ...
  O HAI IM himalayan_load_tester
    VISIBLE "========================================"
    VISIBLE "  HIMALAYAN LOAD_TESTER v4.9"
    VISIBLE "  The purrfect birman lexer"
    VISIBLE "  (C) 2020 Cat Corp"
    VISIBLE "  License: MEOW-51-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "HIMALAYAN LOAD_TESTER"
      config HAS A version ITZ "52.8"
      config HAS A author ITZ "cat_6708"
      config HAS A license ITZ "MEOW-4-CAT"
      config HAS A description ITZ "The purrfect birman lexer for all your cat needs"
      config HAS A cats_needed ITZ 85
      config HAS A treats_per_hour ITZ 41
      config HAS A nap_intervals ITZ 21
      config HAS A meow_volume ITZ "7"
      config HAS A purr_frequency ITZ 28
      VISIBLE "INITIALIZING HIMALAYAN LOAD_TESTER..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING HIMALAYAN LOAD_TESTER ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "HIMALAYAN LOAD_TESTER SHUTTING DOWN... MEOW!"
