HAI 1.2
  ...
  O HAI IM cornish_rex_scope
    VISIBLE "========================================"
    VISIBLE "  CORNISH_REX SCOPE v9.6"
    VISIBLE "  The purrfect ocicat queue"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "CORNISH_REX SCOPE"
      config HAS A version ITZ "13.8"
      config HAS A author ITZ "cat_6008"
      config HAS A license ITZ "MEOW-7-CAT"
      config HAS A description ITZ "The purrfect ocicat queue for all your cat needs"
      config HAS A cats_needed ITZ 36
      ...
      VISIBLE "INITIALIZING CORNISH_REX SCOPE..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 39
      IM IN YO LOOP
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING CORNISH_REX SCOPE ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "CORNISH_REX SCOPE SHUTTING DOWN... MEOW!"
