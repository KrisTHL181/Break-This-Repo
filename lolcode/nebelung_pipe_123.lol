HAI 1.2
  ...
  O HAI IM nebelung_pipe
    VISIBLE "========================================"
    VISIBLE "  NEBELUNG PIPE v1.4"
    VISIBLE "  The purrfect javanese graph"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "NEBELUNG PIPE"
      config HAS A version ITZ "74.5"
      config HAS A author ITZ "cat_4538"
      config HAS A license ITZ "MEOW-17-CAT"
      config HAS A description ITZ "The purrfect javanese graph for all your cat needs"
      ...
      VISIBLE "INITIALIZING NEBELUNG PIPE..."
    IF U SAY SO

    HOW IZ I processInput YR input
      I HAS A result ITZ ""
      I HAS A counter ITZ 0
      I HAS A max_loops ITZ 10
      IM IN YO LOOP
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "NEBELUNG PIPE SHUTTING DOWN... MEOW!"
