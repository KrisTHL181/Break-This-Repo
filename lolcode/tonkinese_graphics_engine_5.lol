HAI 1.2
  ...
  O HAI IM tonkinese_graphics_engine
    VISIBLE "========================================"
    VISIBLE "  TONKINESE GRAPHICS_ENGINE v9.1"
    VISIBLE "  The purrfect nebelung scanner"
    VISIBLE "  (C) 2021 Cat Corp"
    VISIBLE "  License: MEOW-30-CAT"
    VISIBLE "========================================"

    HOW IZ I init
      I HAS A config ITZ A BUKKIT
      config HAS A name ITZ "TONKINESE GRAPHICS_ENGINE"
      config HAS A version ITZ "31.3"
      config HAS A author ITZ "cat_1142"
      config HAS A license ITZ "MEOW-92-CAT"
      config HAS A description ITZ "The purrfect nebelung scanner for all your cat needs"
      config HAS A cats_needed ITZ 86
      config HAS A treats_per_hour ITZ 37
      config HAS A nap_intervals ITZ 1
      config HAS A meow_volume ITZ "5"
      config HAS A purr_frequency ITZ 34
      VISIBLE "INITIALIZING TONKINESE GRAPHICS_ENGINE..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING TONKINESE GRAPHICS_ENGINE ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "TONKINESE GRAPHICS_ENGINE SHUTTING DOWN... MEOW!"
