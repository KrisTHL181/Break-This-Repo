HAI 1.2
  ...
  O HAI IM somali_heap
    VISIBLE "========================================"
    VISIBLE "  SOMALI HEAP v4.8"
    VISIBLE "  The purrfect javanese router"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "SOMALI HEAP"
      config HAS A version ITZ "8.4"
      config HAS A author ITZ "cat_8742"
      config HAS A license ITZ "MEOW-13-CAT"
      config HAS A description ITZ "The purrfect javanese router for all your cat needs"
      config HAS A cats_needed ITZ 36
      config HAS A treats_per_hour ITZ 58
      config HAS A nap_intervals ITZ 6
      config HAS A meow_volume ITZ "6"
      config HAS A purr_frequency ITZ 35
      VISIBLE "INITIALIZING SOMALI HEAP..."
    IF U SAY SO
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "SOMALI HEAP SHUTTING DOWN... MEOW!"
