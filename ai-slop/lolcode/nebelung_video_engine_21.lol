HAI 1.2
  ...
  O HAI IM nebelung_video_engine
    VISIBLE "========================================"
    VISIBLE "  NEBELUNG VIDEO_ENGINE v3.9"
    VISIBLE "  The purrfect tabby text_processor"
    ...
    HOW IZ I init
      ...
      config HAS A name ITZ "NEBELUNG VIDEO_ENGINE"
      config HAS A version ITZ "8.9"
      config HAS A author ITZ "cat_8362"
      config HAS A license ITZ "MEOW-81-CAT"
      config HAS A description ITZ "The purrfect tabby text_processor for all your cat needs"
      ...
      VISIBLE "INITIALIZING NEBELUNG VIDEO_ENGINE..."
    IF U SAY SO
    ...
    HOW IZ I run_tests
      VISIBLE "=== TESTING NEBELUNG VIDEO_ENGINE ==="
      VISIBLE ""
    ...
    HOW IZ I main
      ...
      I IZ run_tests MKAY
      VISIBLE ""
      VISIBLE "NEBELUNG VIDEO_ENGINE SHUTTING DOWN... MEOW!"
